...
public class SocietyFapUserResumeForm {
	...
	public SocietyFapUserResumeForm(long fap_resume_seq, String user_id, String fap_resume_title, String fap_resume_gender,
			String fap_resume_marital, String fap_resume_nationality, String fap_resume_pic_saved,
			String fap_resume_pic_origin, CommonsMultipartFile fap_resume_pic, String fap_resume_birth,
			String fap_resume_dependents, String fap_resume_ins_dt, String fap_resume_ins_id, String fap_resume_udt_dt,
			String fap_resume_udt_id) {
		super();
	...
	public String toString() {
		return "ResumeForm [fap_resume_seq=" + fap_resume_seq + ", user_id=" + user_id + ", fap_resume_title="
				+ fap_resume_title + ", fap_resume_gender=" + fap_resume_gender + ", fap_resume_marital="
				+ fap_resume_marital + ", fap_resume_nationality=" + fap_resume_nationality + ", fap_resume_pic_saved="
				+ fap_resume_pic_saved + ", fap_resume_pic_origin=" + fap_resume_pic_origin + ", fap_resume_pic="
				+ fap_resume_pic + ", fap_resume_birth=" + fap_resume_birth + ", fap_resume_dependents="
				+ fap_resume_dependents + ", fap_resume_ins_dt=" + fap_resume_ins_dt + ", fap_resume_ins_id="
				+ fap_resume_ins_id + ", fap_resume_udt_dt=" + fap_resume_udt_dt + ", fap_resume_udt_id="
				+ fap_resume_udt_id + "]";
	}
