...
public class SocietyFapUserResumeLicense {
	 ...
	 * 점수
	 */
	private int fap_resume_license_score;
	...
	public SocietyFapUserResumeLicense(long fap_resume_license_seq, long fap_resume_seq,
			...
			int fap_resume_license_score, String fap_resume_license_issuing_organization,
	...
	public int getFap_resume_license_score() {
		return fap_resume_license_score;
	}

	public void setFap_resume_license_score(int fap_resume_license_score) {
		this.fap_resume_license_score = fap_resume_license_score;
	}
