...
(function(factory) {
  ...
  var methods = {
    ...
    setDefaults: function( newSettings ) {
        ...
        var settings1 = $.extend(_DEFAULTS, newSettings);
        var settings = $.extend({}, settings1);
		...
		//timepicker_extendRemove( _DEFAULTS, settings || {} );
	},
  ...
  /* 이종호 추가 */
  function timepicker_extendRemove( target, props ) {
	$.extend( target, props );
