...
<body>
    ...
    <div class="container sub05" id="main">
        ...
        <div class="sub-content sub05-03">
            <div class="page-locationWrap">
                <ul class="page-location">
                    ...
                    <li class="img-icon  chevron-right"></li>
                    <li class="division-menu"><a href="/lms/community/sub05-03">특강/설명회</a></li>
                    <!-- <li class="img-icon  chevron-right"></li>
            ...
            <div class="header-box">
                ...
                <h3 class="h3">특강 & 설명회</h3>
                <p class="c999">
                    레인보우가 엄선한 특강과 설명회를 경험해보세요.<br>어쩌면 또 다른 기회를 발견하게 될지 모릅니다.
                </p> -->
            </div>
            <div class="section sub05-03">
                <div class="sub-section">
                    ...
                    <div class="sub-segment table">
                        <ul class="class-list-title thead d-flex">
                            ...
                            <li class="c-table-name-w">특강 & 설명회 주제</li>
                                ...
                                <div class="c-table-name-w ">
                                    <a href="#">
                                        <p class="text-over-lh20">
                                            제목의 글자 수는 37 이하로 제한합니다. 새가 인간은 사랑의 않는 뿐 제목의 글자 수는 37 이하로 제한합니다. 새가 인간은 사랑의 않는 뿐
                                        </p>
                                    </a>
                                </div>
