...
<body>
    ...
    <div class="container subPage_container sub07 d-flex" id="main">
        ...
        <div class="subPage_content sub-content margin-left20 sub07 sub07-02">
            ...
            <div class="section sub07-02">
            <form  action="/lms/user/sub07-02-05-submit" method="post" id="refund_form" class="formStyle" style="text-align: center;">
				<input type="hidden" name="id" value="${refundInfo.user_id}">
				<input type="hidden" name="PAY_TOEFL_SEQ" value="${refundInfo.PAY_TOEFL_SEQ}">
