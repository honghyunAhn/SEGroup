				...
				if(chekMoba()){
					frWidth = frHeight = 0;
					 ...
					 var contStr='';
					  ...
					  contStr+='<source type="application/x-mpegURL" src="${url}" />';
					  contStr+='</video>';
...
<body>
	<div class="lecturePlayer" id="lecturePlayer">
		<div class="body" style="overflow: auto;">
			<div id="playerDiv">
				<iframe name="viewer" id="viewer" src="" scrolling="no"
					webkitAllowFullScreen="true" mozallowfullscreen="true"
					allowFullScreen="true"
					style="margin: 0px auto; border: 0px; overflow: hidden; width: 100%; height: 730px;"
					width="100%">
				</iframe>
			</div>
		</div>
