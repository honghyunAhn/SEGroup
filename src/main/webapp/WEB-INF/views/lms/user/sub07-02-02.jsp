...
$(function() {
	...
	$('#refund_cancel').on('click', function(){
		...
		var pay_user_seq = '${refundInfo.pay_user_seq}';
...
<body>
    ...
    <div class="container subPage_container sub07 d-flex" id="main">
        ...
        <div class="subPage_content sub-content margin-left20 sub07 sub07-02">
                ...
                <div class="sub-segment">
                    ...
                    <ul class="class-list-wrap">
                        ...
                        <li class="class-list d-flex text-center">
                            ...
                            <div class="c-table-01" style="text-align:center; align-self:center;">${refundInfo.price}원</div>
                            ...
                            <c:if test="${refundInfo.dis_point != '' && refundInfo.dis_point != null}">
                            <div class="c-table-01" style="text-align:center; align-self:center;">${refundInfo.dis_point }점</div>
                            </c:if>
                            ...
                            <c:if test="${refundInfo.real_payment != '' && refundInfo.real_payment != null}">
							<div class="c-table-01" style="text-align:center; align-self:center;">${refundInfo.real_payment }원</div>
                            </c:if>
            ...
            <div class="section sub07-02">
            <form  action="/lms/user/sub07-02-02-submit" method="post" id="refund_form" class="formStyle" style="text-align: center;">
