...
<body>
    ...
    <div class="container subPage_container sub07 d-flex">
        ...
        <div class="subPage_content sub-content margin-left20 sub07 sub07-04 sub07-04-01" id="main">
            <!-- 현재 페이지 위치 표시 -->
            ...
            <div class="section">
                ...
                -->
                <form action="/lms/user/updateUser" id="saveForm" class="formStyle" method="post" onsubmit="return formCheck();">
                    <div class="d-flex">
                    ...
                    <div class="d-flex">
                       ...
                       <div class="email">
                            ...
                            </select> <button class="btn_normal input-btn btn_orangeD" type="button" onclick="ajaxCheckEmailDuplicated();">중복확인</button>
                            <!-- <div class="d-none-msg">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="phone mobile-phone">
                            ...
                            <button class="btn_normal input-btn btn_orangeD" type="button" onclick="openDRMOKWindow();">전화번호 변경</button>
                            <!-- <div class="d-none-msg">
                        ...
                        <label class="label" for="adress"> 주소</label>
                         <div class="adressWrap">
                            <div class="adress adress1 d-flex">
                                <input class="input w355" type="text" id="post_code" name="post_code" value="${myInfo.USER_ZIPCODE}" autocomplete="off">
                                <button class="btn_normal input-btn btn_orangeD" type="button" onclick="searchPostcode();">우편번호 검색</button>
                                <!-- <div class="d-none-msg">
                ...
                <div class="button-wrap d-flex">
                    <input type="submit" class="btn-normal btn_medium btn_orangeD" value="수정완료">
                </div>
                </form>
            </div>
        </div>
