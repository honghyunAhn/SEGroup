...
<head>
	...
	$(function() {
		...
		$(document).ready(function() {
			var location = $('.sub-nav .menu-sub .sub02-01-01');
...
<body>
	...
	<div class="container subPage_container eLearning sub02 d-flex">
		<!-- sub02 foreign-include -->
		<%@include file="../../course/foreign/menu/leftmenu.jsp"%>

		<div class="subPage_content sub02-01-01 margin-left20" id="main">
			<div class="section section-class-detail sub02-01-01-01">
				<!-- 과정상세 -->
				<div class="class-list class-detail sub02-01-01-01">
					<div class="c-ttl">
