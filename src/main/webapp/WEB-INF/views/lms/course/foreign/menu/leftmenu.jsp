            ...
            $('.subPage_nav .lnb>a').each(function() {
                $(this).on('click', function(){
                	...
                	if(moveFlag!=''&&moveFlag!=null){
						...
						document.location.href = "/lms/course/foreign/sub02-01?parent_menu=" + clicked_parent;
                ...
                $(this).on('click', function(){
					...
					setDefault();
             		...
             		if(moveFlag!=''&&moveFlag!=null){
						...
						document.location.href = "/lms/course/foreign/sub02-01?son_menu=" + clicked_son;
...
<body>
    <div class="subPage_nav">
        <ul class="sub-navGroup">
            <li class="gnb sub02 fz18 bg_point menuList"><a href="/lms/course/foreign/sub02-01">외국어</a></li>
        </ul>
    </div>
</body>
