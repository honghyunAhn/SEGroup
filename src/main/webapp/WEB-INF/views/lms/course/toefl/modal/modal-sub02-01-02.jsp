...
<body>
    <div class="sub-content sub-modal-02">
        ...
        <div class="modal-sectionWrap">
            <header class="article-title">
                <div class="titleBar-hdr">수강취소 및 환불 관련 규정</div>
            </header>
            ...
            <form class="checkWrap">
                <label>
                    <input type="checkbox" class="check input" id="agree01" name="agree01">
                    위 내용에 동의합니다.
                </label>
            </form>
...
<!--             <button class="button btn-wh btn-prev prev-step2" type="button">이전</button> -->
        ...
        $(document).ready(function() {
            ...
            $('.next-step2').click(function() {
            	...
            	if(!$('#agree01').prop('checked')){
            		alert('환불규정을 확인하고, 동의 버튼을 체크해주세요');
            		return;
            	};
            	
            	$(".modal-content:eq(1)").css("display","none");
            	$(".modal-content:eq(2)").css("display","block");
