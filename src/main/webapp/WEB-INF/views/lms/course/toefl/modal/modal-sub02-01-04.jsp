...
<body>
    <div class="sub-content">
        ...
        <ul class="processWrap d-flex">
            ...
            <li class="process active"><span class="margin-right10 h5 fc_orD">04</span>결제</li>
        </ul>
        <!-- <div class="modal-sectionWrap"> -->
            <div class="section modal-sub02-01-04">
                ...
                <div class="button-wrap d-flex">
                    ...
                    <button class="btn_point btn_xsmall btn_normal" type="button" onclick="location.href='/lms/user/sub07-01-01'">
                        나의강의실로 이동
                    </button>
                </div>
            </div>
