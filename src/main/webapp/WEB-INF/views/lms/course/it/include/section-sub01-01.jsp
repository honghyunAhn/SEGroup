			...
			$.ajax({
				...
				success	: function(data) {
					...
					$('.courseDetail').on('click', function(){
						...
						document.location.href = "/lms/course/it/sub01-01-01-01?course_id=" + course_id;
				    ...
				    $('.modal-popup').click(function() {
						...
						var courseId = $(this).parent().parent().children('.c-ttl').find('div.txt-ov-2').attr('data-value');
...
/* 				    	var discountPrice = $(this).parent().parent().children('.c-price').children('.tableWrap').children('.discountPrice').html(); */
				    	var learnPeriod =  $('.c-ctt').children('.term').eq(index).attr('data-value');
...
/*     						var today = new Date();   
					...
					$('#modal_learn_days').html("신청기간을 선택해주세요.");
