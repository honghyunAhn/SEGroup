            ...
            $('.sub-nav .lnb>a').each(function() {
                $(this).on('click', function(){
                	...
                	if(moveFlag!=''&&moveFlag!=null){
						...
						document.location.href = "/lms/course/jobtraining/sub04-01?parent_menu=" + clicked_parent;
                ...
                $(this).on('click', function(){
					...
					setDefault();
             		...
             		if(moveFlag!=''&&moveFlag!=null){
						...
						document.location.href = "/lms/course/jobtraining/sub04-01?son_menu=" + clicked_son;
...
<body>
    <div class="sub-nav">
        <ul class="sub-navGroup">
            <li class="gnb sub04 fz18 menuList"><a href="/lms/course/jobtraining/sub04-01">취업연계</a></li>
