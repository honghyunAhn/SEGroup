...
<body>
	...
	<div class="container subPage_container d-flex">
		<div class="subPage_nav">
			<ul class="sub-navGroup">
				<li class="gnb sub02 fz18 bg_point menuList"><a href="#">과정검색</a></li>
			</ul>
		</div>
		...
		<div class="subPage_content margin-left20" id='main'>
			<div class="sp_header">
                <div class="header_textWrap">
                    <h3 class="h3">과정검색</h3>
                     <p class="fc_999">두잇캠퍼스의 모든 교육과정을 검색해보세요.</p>
                </div>
            </div>
            
			<!-- 과정목록 -->
			<div class="section">
				<%@include file="include/section-sub05-01.jsp"%>
			</div>
			<!-- pagenation  -->
			<div class="page">
