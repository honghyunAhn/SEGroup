...
<body>
   ...
   <%@include file="../../sub_header.jsp"%>
    ...
    <div class="container subPage_container sub03 d-flex">
        <!-- sub03t-include -->
        ...
        <div class="subPage_content margin-left20" id="main">
           <div class="sp_header">
                <div class="header_textWrap">
                    <h3 class="h3">직무역량</h3>
                    <p class="fc_999">온라인으로 손쉽게 배울 수 있는 강의! 업무와 회사생활에서 필요한 스킬과 법정 의무교육</p>
                </div>
            </div>
            
            <div class="section">  <!-- sub01-01클래스에 이미지 파일 설정되어 있으므로 클래스명 제외 -->
                <!-- section-sub03-01-include -->
               <%@include file="include/section-sub03-01.jsp"%>                
            </div>
            <!-- pagenation  -->
            <div class="page">
