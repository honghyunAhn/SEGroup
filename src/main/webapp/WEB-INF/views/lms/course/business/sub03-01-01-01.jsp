...
<head>
	...
	$(function() {
		...
		$(document).ready(function() {
			var location = $('.sub-nav .menu-sub .sub03-01-01');
...
<body>
	...
	<div class="container subPage_container eLearning sub03 d-flex">
		<!-- sub03 business-include -->
		<%@include file="../../course/business/menu/leftmenu.jsp"%>

		<div class="subPage_content sub03-01-01 margin-left20" id="main">
			<div class="section section-class-detail sub03-01-01-01">
				<!-- 과정상세 -->
				<div class="class-list class-detail sub03-01-01-01">
					<div class="c-ttl">
