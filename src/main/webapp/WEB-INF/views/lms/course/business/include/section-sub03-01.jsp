			...
			$.ajax({
				...
				success	: function(data) {
					...
					$.each(data, function(index, courseList){
						...
						content += '<li class="class-list d-flex justify_between' + ' load-sub03-01-01">';
						...
						if(courseList.tasting_url){
							...
							content += 		'<div class="c-ctt">';
							content += 		'<a class="btn_default btn_xsmall" onclick="alert(\'맛보기가 설정되어 있지 않습니다.\')"</a>>';
							content += 		'</div>';
						}
					...
					$('.courseDetail').on('click', function(){
						...
						document.location.href = "/lms/course/business/sub03-01-01-01?course_id=" + course_id;
