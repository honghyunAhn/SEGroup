			...
			$.ajax({
				...
				success	: function(data) {
					...
					$.each(data, function(index, courseList){
						...
						content += '<li class="class-list cl0' + (index + 1) + ' load-sub01-01-01">';
...
/* 						content += 				'<p class="fz16 discountPrice">할인금액처리</p>';  */
						...
						content += 		'<div class="c-ctt"><a class="button btn-pColor modal-popup" style="background-color: #80b59b;">';
				    ...
				    $('.modal-popup').click(function() {
				    	...
				    	/* 팝업정보 세팅 */				    	
				    	var classNm = $('.class-title-wrap').children('.txt-ov-2').html();
				    	var courseId = $('.class-title-wrap').children('.txt-ov-2').attr('data-value');
