...
<body>
   ...
   <%@include file="../../header.jsp"%>
    ...
    <div class="container eLearning sub01" id="main">
        <!-- sub01it-include -->
        <%@include file="../../course/jobmarket/menu/leftmenu.jsp"%>

        <div class="sub-content sub01">
            <!-- 현재 페이지 위치 표시 -->
            <div class="page-locationWrap">
                ...
                -->
                    ...
                    <li class="category-menu"><a href="/lms/course/it/sub01-01">ICT</a></li>
                    <li class="img-icon chevron-right"></li>
            ...
            <div class="section">  <!-- sub01-01클래스에 이미지 파일 설정되어 있으므로 클래스명 제외 -->
               ...
               <%@include file="include/section-sub06-01.jsp"%>                
            </div>
            <!-- pagenation  -->
            <div class="page">
