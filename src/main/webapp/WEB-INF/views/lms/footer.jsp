...
<head>
	...
	<script>
	  ...
	  gtag('config', 'G-3TFEY7PQYG');
	</script>
</head>
<div class="img-icon top-btn scrollToTop"></div>
<!-- Footer >> 2. 로고/회사정보/SNS링크 -->
<footer class="footer">
	<div class="footer_wrap d-flex justify_between">
		<!-- Footer >> 1) 로고/회사정보/SNS링크 -->
		<div class="footer_infoWrap">
			<div class="footer_logo">
				<a href="#"> <img src="/resources/lms/img/DIC_logo.png" alt="SES 기업로고">
				</a>
			</div>
			<div class="footer_textWrap margin-top10">
				<ul class="lh30">
					<li>(주) 소프트엔지니어소사이어티&nbsp;|&nbsp;대표 : 김치중</li>
					<li>사업자등록번호 : 468-81-00409 
						<a class="btn_default btn_xsmall margin-left5" href="http://www.ftc.go.kr/bizCommPop.do?wrkr_no=4688100409" target="_blank">사업자 정보확인</a>
					</li>
					<li>통신판매업신고번호 : 제 강남-03736호</li>
					<li>서울시 강남구 영동대로513, 4층 017-1호(삼성동, 코엑스)</li>
					<li>02-6000-6251&nbsp;|&nbsp;info@softsociety.net</li>
				</ul>
			</div>
		</div>
		<!-- Footer >> 2) 회사정보/푸터메뉴 -->
	...
	<!-- Footer >> 3. Copyright -->
	<div class="copyright h5 fc_aaa textAlign_center margin-top40">
