		...
		<div class="main sideL">
			...
			<form class="login_wrap">
				...
				<div class="login-util">
					<a href="<c:url value="/user/signout"/>">로그아웃</a><i>I</i><a href="<c:url value="/mypage/private/privateedit"/>">개인 정보 수정</a><i>I</i><a href="<c:url value="/mypage/note/received"/>">쪽지함</a>
				</div>
			</form>
			</sec:authorize>
...
$(document).ready(function(){
	$('.main_slide').slick({
		...
		customPaging: function(slider, i) {
			var txt = $('.main_slide img.slider_image').eq(i+1).attr('alt');
