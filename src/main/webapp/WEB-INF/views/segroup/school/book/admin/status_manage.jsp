			...
			$.ajax({
				...
				success : function(data) {
					...
					$.each(data, function(index, val) {
						...
						output += "<td>" + val.book_label + "</td>";
						output += "<td>" + val.user_nm + "</td>";
						output += "<td>" + val.rental_req_dt + "</td>";
						output += "<td>" + val.rental_rtn_due_dt + "</td>";
						output += "<td>" + val.rental_req_state + "</td>";
						output += '</tr>'
					});
...
<body>
	...
	-->
			...
			<div class="sidebar-wrapper">
				<div class="logo">
					<a href="admin_main" class="simple-text"> SES Library<br>for
						Admin
					</a>
				</div>
				...
				<ul class="nav">
					...
					<li class="active"><a href="status_manage"> <i
							class="ti-bookmark"></i>
							<p>대여 현황</p>
					</a></li>
								...
								<div class="content">
									<div class="card card-plain">
										<div class="col-md-2" style="float: right;">
											<select id="sort-select" class="form-control border-input">
												<option value="0">반납예정일</option>
												<option value="1">대여일</option>
