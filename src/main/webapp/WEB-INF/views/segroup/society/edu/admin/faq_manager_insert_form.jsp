...
<body ng-app="myapp">
	...
	<div class="page_title">
		...
		<h5>FAQ 상담 게시판 관리 페이지&nbsp;&nbsp;&gt;&nbsp;&nbsp;게시글 등록</h5>
	</div>
	<form action="/edu/admin/faq_manager_contents_insert" method="post"  enctype="multipart/form-data" onsubmit="return formCheck();">
		<table class="board_view">
			...
			<tbody>
				<tr>
					<th scope="row">작성자</th>
				    <td>${consulting_ins_id }<input type="hidden" name="consulting_ins_id" id="consulting_ins_id" value="${consulting_ins_id}"></td>
				</tr>
				<tr>
					<th scope="row">FAQ종류</th>
				    <td>
				...
				<tr>
				    <th scope="row">제목</th>
				    <td colspan="3">
				        <input type="text" name="consulting_title" id="consulting_title" size="100" />
				    </td>
				</tr>
				<tr>
		...
		<div class="boardManagerDiv">
			<input type="submit" class="crc_submit" id="faqInsertBtn" value="등록하기" />
