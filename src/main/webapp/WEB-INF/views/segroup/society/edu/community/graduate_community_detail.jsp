...
<script>
	...
	function goToNear(seq, nearType) {
		location.href = "/edu/community/graduate_community_detail.do?seq=" + seq + "&searchOption=" + nearType;
	}

	function goToList() {
		location.href = "/edu/community/graduate_community.do";
	}
</script>
<style>
.top_img {
	position: relative;
	background-image:
		url(/resources/segroup/society/edu/image/main/top_img/top_img_graduate.jpg);
	height: 250px;
