...
// 		alert("Ajax 신청서비스 들어가기 전~!");
	    ...
	    $.ajax({
	    	type: "POST",
	        url: '<c:url value="/edu/consulting/apply_online" />',
	        data: formData,
...
<!-- 		</div> -->
		<div id="update">
			<div class="form_box">
				<form id="multiForm" name="multiForm" onsubmit="return checkOnSubmit();">
					...
					<div class="master_agree_wrap">
						<div class="master_agree">
							<p class="agree_title">(주)ICT 이용약관</p>
							<p class="agree_text">
								제1조(목적)<br> 이 약관(이하 '약관')은 주식회사 ICT(이하 회사라 합니다)과 이용 고객(이하
								'회원')간에 회사가 제공하는 서비스의 가입조건 및 이용에 관한 제반 사항과 기타 필요한 사항을 구체적으로 규정함을
								목적으로 합니다.
							</p>
						</div>
						<!-- agree -->
						...
						<div class="agree_line">
							<p>
							<b class="check_box"></b>
								개인정보 처리방침 동의<span class="see_more sm1">전문보기 +</span>
							</p>
						</div>
						<!-- agree_line -->
					</div>
					...
					<div class="line line_align_center">
						...
						<input class="join_btn ip_4" type="button" onclick="goToList()" value="신청취소">
					</div>
				</form>
			</div>
		</div>
	...
	<div class="agree_pop_bk">
		<div class="agree_all agree_all_01">
			<div class="agree_all_txt">
				...
				<p class="agree_text">
					제 1 조 목적<br> 본 약관은 서비스 이용자가 주식회사 (이하 “회사”라 합니다)가 제공하는 온라인상의
					인터넷 서비스(이하 “서비스”라고 하며, 접속 가능한 유∙류와는 상관없이 이용 가능한 회사가 제공하는 모든 서비스를
					회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 회사가 본 약관은 서비스 이용자가 주식회사 (이하
					“회사”라 합니다)가 제공하는 온라인상의 인터넷 서비스(이하 “서비스”라고 하며, 접속 가능한 유∙류와는 상관없이 이용
					가능한 회사가 제공하는 모든 서비스를 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 회사가 본
					약관은 서비스 이용자가 주식회사 (이하 “회사”라 합니다)가 제공하는 온라인상의 인터넷 서비스(이하 “서비스”라고 하며,
					접속 가능한 유∙류와는 상관없이 이용 가능한 회사가 제공하는 모든 서비스를 회원가입 신청하시는 분께 수집하는 개인정보의
					항목, 개인정보의 수집 회사가 본 약관은 서비스 이용자가 주식회사 (이하 “회사”라 합니다)가 제공하는 온라인상의 인터넷
					서비스(이하 “서비스”라고 하며, 접속 가능한 유∙류와는 상관없이 이용 가능한 회사가 제공하는 모든 서비스를 회원가입
					신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 회사가 본 약관은 서비스 이용자가 주식회사 (이하 “회사”라
					합니다)가 제공하는 온라인상의 인터넷 서비스(이하 “서비스”라고 하며, 접속 가능한 유∙류와는 상관없이 이용 가능한
					회사가 제공하는 모든 서비스를 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 회사가 본 약관은
					서비스 이용자가 주식회사 (이하 “회사”라 합니다)가 제공하는 온라인상의 인터넷 서비스(이하 “서비스”라고 하며, 접속
					가능한 유∙류와는 상관없이 이용 가능한 회사가 제공하는 모든 서비스를 회원가입 신청하시는 분께 수집하는 개인정보의 항목,
					개인정보의 수집 회사가 본 약관은 서비스 이용자가 주식회사 (이하 “회사”라 합니다)가 제공하는 온라인상의 인터넷
					서비스(이하 “서비스”라고 하며, 접속 가능한 유∙류와는 상관없이 이용 가능한 회사가 제공하는 모든 서비스를 회원가입
					신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 회사가
				</p>
			</div>
