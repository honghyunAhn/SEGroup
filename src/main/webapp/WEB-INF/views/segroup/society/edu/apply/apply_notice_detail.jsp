...
<script>
	...
	function goToNear(seq, nearType) {
		location.href = "/edu/apply/apply_notice_detail.do?seq=" + seq + "&searchOption=" + nearType;
	}

	function goToList() {
		location.href = "/edu/apply/apply_notice.do";
	}
</script>
</head>
<body>
	<%@include file="../menu.jsp"%>
	<img src="<c:url value="/resources/segroup/society/edu/image/sub/images/sub_top_img.png" />" alt="sub_top_img" height="250px" width="100%" />
