...
<body ng-app="myapp">
	...
	<div class="sub_m_contents">
		<div class="main_top_slidewrap">
			<h1 align="center">프리토킹1:1개인지도(SKYPE대응)</h1>
			<div class="spacing50"></div>
			...
			<table id="infotb" class="indent">
				<tr>
					<td>∘ 과정명</td>
					<td>프리토킹1:1개인지도(SKYPE대응)</td>
				</tr>
				<tr>
					<td>∘ 일시</td>
					<td>2020년 1월 6일(월) ~ 2월 28일(금) [(30min/1일) 최대 주2회 총8시간] (1월/2월/1~2월 개별 신청가능)</td>
				</tr>
				<tr>
					<td>∘ 장소</td>
			...
			<table id="currtb" class="indent">
				...
				<tr>
					<td>1월~2월</td>
					<td rowspan="2" style="text-align: center;">최대 주2회(30분/일)</td>
					<td style="text-align: left;">
						1. 철저한 오더 메이드 방식지도<br>
						2. 학생의 부족한 부분만 핀포인트 보강<br>
						3. 1:1지도의 가성비와 학생 레벨 파악용이<br>
						4. 스터디룸 무료자습가능
					</td>
				</tr>
			</table>
			<div class="spacing30"></div>
			<h3>해당 과정은 조기 마감되었습니다. 성원에 감사드립니다.</h3>
            	...
            	<div class="notice_wrap" style="width: 100%;">
            		<table>
						...
						<c:forEach var="data" items="${shortTermList}" varStatus="status">
	           				<tr class="notice_top">
								<td style="width: 30%; text-align: left; padding-left: 30px;">프리토킹1:1개인지도(SKYPE대응)</td>
								<td>2019-01-06~2020-02-29</td>
								<td>8시간</td>
								<td>2019-12-26~2019-12-31</td>
								<td>
