...
<body ng-app="myapp">
	...
	<div class="sub_m_contents">
		<div class="main_top_slidewrap">
			<h1 align="center">일본어로 배우는 OA기초</h1>
			<div class="spacing50"></div>
			<h3>∘ 강좌안내</h3>
			<div class="indent">
				이 강좌는 일본에서 취업 또는 실무 예정자를 대상으로 원활히 업무수행을 위한 필수 OA업무를 실제 일본 MS Office프로그램을 사용하여 학습하는 과정입니다.<br><br>
				...
				장래 일본취업을 계획하고 계시거나 일본취업이 결정된 분 또는 주재원 내정되신 분은 이 과정을 수강하시여 일본취업에 유리한 자질을 확보하시길 바랍니다.<br><br>
				감사합니다.
			</div>
			...
			<table id="infotb" class="indent">
				...
				<tr>
					<td>∘ 교육목표</td>
					<td>
						- OA과목에 일본어를 접목시켜 당장 일본기업에 입사 또는 업무를 시작하더라도 OA업무에 지장이 없도록 기본적인 지식을 학습합니다.<br>
						- 일본어로 기초적인 업무를 할 수 있고 일본기업문화특징을 이해합니다.
					</td>
				</tr>
				<tr>
					<td>∘ 교육대상</td>
					<td>일본취업희망자/예정자/주재원 등</td>
				</tr>
				<tr>
					<td>∘ 일시</td>
					<td>2020년 1월 6일(월) ~ 1월 31일(금) 13:00 ~ 16:00 [(3hr/1일) 주3일 총45시간]</td>
				</tr>
				<tr>
					<td>∘ 장소</td>
			...
			<img src="/resources/segroup/society/edu/image/main/japan_oa_img02.bmp" style="vertical-align: middle; width: 280px; height: 187px; padding-left: 275px;">
			<div class="spacing30"></div>
			<h3>∘ 교육일정 및 커리큘럼</h3>
			<table id="currtb" class="indent">
				...
				<tr>
					...
					<td style="text-align: left;">
						1. 일본어 자판 및 문자변환 방법<br>
						2. 일본어 OA프로그램 매뉴얼 이해<br>
						3. MS Office 기본기능 익히기<br>
						4. MS Office로 일본어 문서 작성하기<br>
						5. 기획서 및 보고서 만들기 
					</td>
				</tr>
			</table>
