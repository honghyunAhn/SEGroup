	...
	<div class="sub_m_contents">
		<div class="main_top_slidewrap">
			...
			<table id="infotb" class="indent">
				...
				<tr>
					<td>∘ 교육대상</td>
					<td>37기 SC IT마스터 수료생</td>
				</tr>
				<tr>
					<td>∘ 일시</td>
					<td>2020년 1월 6일(월) ~ 2월 28일(금) [(1hr/1일) 주3일 총24시간] (1월/2월/1~2월 개별 신청가능)</td>
				</tr>
				<tr>
					<td>∘ 장소</td>
			...
			<table id="currtb" class="indent">
				...
				<tr>
					<td>1월~2월</td>
					<td rowspan="2" style="text-align: center;">추후안내예정</td>
