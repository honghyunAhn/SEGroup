...
<body ng-app="myapp" ng-controller="SocietyEduAdminViewController">
	...
	<div class="custom_div">
		<form action="/edu/admin/subbanner_insert"
			...
			<table class="gisu_crc_table">
				...
				<tbody>
					<tr>
						...
						<td>
							<input type="text" value="${gisu_crc_nm_list.get(0)}" name="edu_sub_ban_nm" id="edu_sub_ban_nm"maxlength="100" readonly="readonly">
						</td>
					</tr>
					<tr>
						<td class="name">링크
						...
						<td><input type="text" name="edu_sub_ban_link" id="edu_sub_ban_link" readonly="readonly"></td>
					</tr>
					<tr>
						<td class="name">신청 시작일</td>
						<td><input type="text" name="edu_sub_ban_st" id="edu_sub_ban_st"></td>
					</tr>
					<tr>
						<td class="name">신청 종료일</td>
						<td><input type="text" name="edu_sub_ban_et" id="edu_sub_ban_et"></td>
					</tr>
					 <tr>
                    <td class="name">서브배너 등록 이미지</td>
                    <td>
                        ...
                        <img alt="서브배너 등록 이미지 미리보기" src="/image/user-empty.png" id="avatar_info_image1" style="border: 1px solid black"/><br/>
                    </td>
                	</tr>
			</table>
			
			<input class="subbanner_submit" type="submit" value="등록하기">
		</form>
	</div>
