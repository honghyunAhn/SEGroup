...
<script type="text/javascript">
	$(function() {
		$('#agree_btn').on('click', pushAgreeButton);
		$('#disagree_btn').attr('href', '<c:url value="/ictcenter" />');
		
		
	});

	function pushAgreeButton() {
		var canPass = true;
		var checkboxes = $('.agree_box .agree_line b.check_box');

		$.each(checkboxes, function(index, box) {
			if ($(box).hasClass('check_box_a') == false) {
				alert('이용약관 및 개인 정보 수집 및 이용에 동의해주세요');
				canPass = false;
				return false;
			}
		});
		...
		if (canPass) {
			location.href = "<c:url value="/edu/user/user_join_terms_agree" />";
		}
	}
...
<body>
	...
	<section class="join_section">
		<article>
			...
			<ul class="join_system">
				...
				<li class="join_box">2.ID/비밀번호 설정</li>
				<li class="join_line"></li>
			...
			<div class="agree_box">
				<div class="agree agree_1">
					...
					<ul style="list-style-type: none;">
						...
						<li>제2조(개인정보의 처리 및 보유기간) ① SES는 법령에 따른 개인정보
							...
							보유&nbsp;&middot;&nbsp;이용기간 내에서 개인정보를 처리&nbsp;&middot;&nbsp;보유합니다.</li>
						<li>&nbsp;</li>
						...
						<li>1. 홈페이지 회원 가입 및 관리</li>
						<li>&nbsp;&middot;&nbsp;필수항목 : 성명, 생년월일, 아이디, 비밀번호, 전화번호, 성별,
							이메일주소</li>
						<li>&nbsp;</li>
						<li>2. 재화 또는 서비스 제공</li>
						<li>&nbsp;&middot;&nbsp;필수항목 : 성명, 생년월일, 아이디, 비밀번호, 주소, 전화번호,
							이메일주소, 신용카드번호, 은행계좌정보 등 결제정보</li>
						...
						<li>SES는 파기 사유가 발생한 개인정보를 선정하고, SES의 개인정보 보호책임자의 승인을 받아 개인정보를
							파기합니다.</li>
						<li>2. 파기방법</li>
						<li>SES는 전자적 파일 형태로 기록&nbsp;&middot;&nbsp;저장된 개인정보는 기록을 재생할 수
							없도록 로우레밸포멧(Low Level Format) 등의 방법을 이용하여 파기하며, 종이 문서에
				...
				<div class="agree agree_2">
					<p class="agree_title">(주)소프트엔지니어소사이어티(Soft Engineer Society)
						이용약관</p>
					<p class="agree_text">
					<ul style="list-style-type: none;">
						...
						<li>&nbsp;</li>
						<li>&nbsp;&nbsp;④ ‘비회원’이라 함은 회원에 가입하지 않고 “소프트엔지니어소사이어티”가 제공하는
						...
						<li>&nbsp;&nbsp;① “소프트엔지니어소사이어티”는 이 약관의 내용과 상호 및 대표자 성명, 영업소
							...
							통신판매업 신고번호, 개인정보관리책임자 등을 이용자가 쉽게 알 수 있도록 소프트엔지니어소사이어티의 초기
						...
						<li>&nbsp;</li>
						<li>&nbsp;&nbsp;⑤ “소프트엔지니어소사이어티”가 약관을 개정할 경우에는 그 개정약관은 그 적용일자
							...
							“소프트엔지니어소사이어티”에 송신하여 “소프트엔지니어소사이어티”의 동의를 받은 경우에는 개정약관 조항이 적용됩니다.</li>
						<li>&nbsp;</li>
						...
						<li>&nbsp;&nbsp;② “소프트엔지니어소사이어티”가 제3자에게 구매자 개인정보를 제공·위탁할 필요가
							있는 경우 실제 구매신청 시 구매자의 동의를 받아야 하며, 회원가입 시 미리 포괄적으로 동의를 받지 않습니다. 이 때
							“소프트엔지니어소사이어티”는 제공되는 개인정보 항목, 제공받는 자, 제공받는 자의 개인정보 이용 목적 및 보유‧이용
							기간 등을 구매자에게 명시하여야 합니다. 다만 「정보통신망이용촉진 및 정보보호 등에 관한 법률」 제25조 제1항에
							의한 개인정보 취급위탁의 경우 등 관련 법령에 달리 정함이 있는 경우에는 그에 따릅니다.</li>
						<li>&nbsp;</li>
						<li>&nbsp;</li>
						<li>제10조 (계약의 성립)</li>
						<li>&nbsp;</li>
						...
						<li>제14조(환급) “소프트엔지니어소사이어티”는 이용자가 구매신청한 재화 등이 품절 등의 사유로 인도 또는
							...
							받은 날부터 3영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다.</li>
						<li>&nbsp;</li>
						<li>제15조(청약철회 등)</li>
						<li>&nbsp;</li>
						<li>&nbsp;&nbsp;① “소프트엔지니어소사이어티”와 재화등의 구매에 관한 계약을 체결한 이용자는
							「전자상거래 등에서의 소비자보호에 관한 법률」 제13조 제2항에 따른 계약내용에 관한 서면을 받은 날(그 서면을 받은
							때보다 재화 등의 공급이 늦게 이루어진 경우에는 재화 등을 공급받거나 재화 등의 공급이 시작된 날을 말합니다)부터
							7일 이내에는 청약의 철회를 할 수 있습니다. 다만, 청약철회에 관하여 「전자상거래 등에서의 소비자보호에 관한
							법률」에 달리 정함이 있는 경우에는 동 법 규정에 따릅니다.</li>
						<li>&nbsp;</li>
						...
						<li>&nbsp;&nbsp;② “소프트엔지니어소사이어티”는 위 대금을 환급함에 있어서 이용자가 신용카드 또는
							전자화폐 등의 결제수단으로 재화 등의 대금을 지급한 때에는 지체 없이 당해 결제수단을 제공한 사업자로 하여금 재화
							등의 대금의 청구를 정지 또는 취소하도록 요청합니다.</li>
						<li>&nbsp;</li>
						...
						<li>&nbsp;&nbsp;⑤ “소프트엔지니어소사이어티”가 제3항과 제4항에 의해 이용자의 동의를 받아야
							...
							등에 관한 법률」 제22조제2항이 규정한 사항을 미리 명시하거나 고지해야 하며 이용자는 언제든지 이 동의를 철회할 수
							있습니다.</li>
						<li>&nbsp;</li>
				...
				<div class="agree_line">
					<p class="terms">
						<b class="check_box"></b>이용약관<span class="see_more sm2">전문보기
							+</span>
					</p>
				</div>
				<!-- agree_line -->
			...
			<p class="agree_check">
				이용약관 및 개인 정보 수집 및 이용에 모두 동의합니다.<b class="ch_lg"></b>
			</p>
			
			 

			<div class="btn_wrap">
				<a class="btn btn_gray btn_fore_black" type="button" id="disagree_btn">나가기</a> 
				<a class="btn btn_b" style="color: white;" type="button" id="agree_btn">계속하기</a>
			</div>
		</article>
	</section>
	<!--  join_section -->
	...
	<div class="agree_pop_bk">
		<div class="agree_all agree_all_01">
			<div class="agree_all_txt">
				...
				<ul style="list-style-type: none;">
					...
					<li>1. 홈페이지 회원 가입 및 관리</li>
					<li>회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별&nbsp;&middot;&nbsp;인증,
						회원자격 유지&nbsp;&middot;&nbsp;관리, 제한적 본인확인제 시행에 따른 본인확인, 서비스 부정이용 방지,
						만 14세 미만 아동의 개인정보 처리시 법정대리인의 동의여부 확인, 각종 고지&nbsp;&middot;&nbsp;통지,
						고충처리 등을 목적으로 개인정보를 처리합니다.</li>
					<li>2. 재화 또는 서비스 제공</li>
					<li>물품배송, 서비스 제공, 콘텐츠 제공, 맞춤서비스 제공, 본인인증, 연령인증,
						요금결제&nbsp;&middot;&nbsp;정산, 채권추심 등을 목적으로 개인정보를 처리합니다.</li>
					<li>3. 고충처리</li>
					...
					<li>- 제공받는 자의 보유&nbsp;&middot;&nbsp;이용기간 : 결제일로부터 1년</li>
					<li>&nbsp;</li>
					<li>제4조(정보주체의 권리&nbsp;&middot;&nbsp;의무 및 행사방법) ① 정보주체는 SES에 대해
						언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.</li>
					<li>1. 개인정보 열람요구</li>
					<li>2. 오류 등이 있을 경우 정정 요구</li>
					<li>3. 삭제요구</li>
					<li>4. 처리정지 요구</li>
		...
		<div class="agree_all agree_all_02">
			<div class="agree_all_txt">
				<p class="agree_title">(주)소프트엔지니어소사이어티(Soft Engineer Society)
					이용약관</p>
				<p class="agree_text">
				<ul style="list-style-type: none;">
					<li>제1조(목적) 이 약관은 (주)소프트엔지니어소사이어티(Soft Engineer Society)이 운영하는
						인터넷 관련 서비스(이하 “소프트엔지니어소사이어티”라 한다)를 이용함에 있어 소프트엔지니어소사이어티와 이용자의
					...
					<li>&nbsp;&nbsp;① “소프트엔지니어소사이어티”가란 (주)소프트엔지니어소사이어티(Soft
						...
						Engineer School)이 운영하는 사업자의 의미로도 사용합니다.</li>
					<li>&nbsp;</li>
					<li>&nbsp;&nbsp;② “이용자”란 “소프트엔지니어소사이어티”에 접속하여 이 약관에 따라
						“소프트엔지니어소사이어티”가 제공하는 서비스를 받는 회원 및 비회원을 말합니다.</li>
					<li>&nbsp;</li>
					<li>&nbsp;&nbsp;③ ‘회원’이라 함은 “소프트엔지니어소사이어티”에 회원등록을 한 자로서, 계속적으로
						“소프트엔지니어소사이어티”가 제공하는 서비스를 이용할 수 있는 자를 말합니다.</li>
					<li>&nbsp;</li>
					<li>&nbsp;&nbsp;④ ‘비회원’이라 함은 회원에 가입하지 않고 “소프트엔지니어소사이어티”가 제공하는
						서비스를 이용하는 자를 말합니다.</li>
					<li>&nbsp;</li>
					...
					<li>&nbsp;&nbsp;① “소프트엔지니어소사이어티”는 이 약관의 내용과 상호 및 대표자 성명, 영업소
						...
						서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.</li>
					<li>&nbsp;</li>
					<li>&nbsp;&nbsp;② “소프트엔지니어소사이어티은 이용자가 약관에 동의하기에 앞서 약관에 정하여져 있는
						내용 중 청약철회․배송책임․환불조건 등과 같은 중요한 내용을 이용자가 이해할 수 있도록 별도의 연결화면 또는 팝업화면
						등을 제공하여 이용자의 확인을 구하여야 합니다.</li>
					<li>&nbsp;</li>
					<li>&nbsp;&nbsp;③ “소프트엔지니어소사이어티”는 「전자상거래 등에서의 소비자보호에 관한 법률」,
					...
					<li>&nbsp;</li>
					<li>&nbsp;&nbsp;⑤ “소프트엔지니어소사이어티”가 약관을 개정할 경우에는 그 개정약관은 그 적용일자
						이후에 체결되는 계약에만 적용되고 그 이전에 이미 체결된 계약에 대해서는 개정 전의 약관조항이 그대로 적용됩니다. 다만
						이미 계약을 체결한 이용자가 개정약관 조항의 적용을 받기를 원하는 뜻을 제3항에 의한 개정약관의 공지기간 내에
						“소프트엔지니어소사이어티”에 송신하여 “소프트엔지니어소사이어티”의 동의를 받은 경우에는 개정약관 조항이 적용됩니다.</li>
					<li>&nbsp;</li>
					<li>&nbsp;&nbsp;⑥ 이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 전자상거래 등에서의
						소비자보호에 관한 법률, 약관의 규제 등에 관한 법률, 공정거래위원회가 정하는 「전자상거래 등에서의 소비자 보호지침」
						및 관계법령 또는 상관례에 따릅니다.</li>
					<li>&nbsp;</li>
					<li>제4조(서비스의 제공 및 변경)</li>
					<li>&nbsp;</li>
					<li>&nbsp;&nbsp;① “소프트엔지니어소사이어티”는 다음과 같은 업무를 수행합니다.</li>
					...
					<li>&nbsp;</li>
					<li>&nbsp;&nbsp;② “소프트엔지니어소사이어티”는 재화 또는 용역의 품절 또는 기술적 사양의 변경
						등의 경우에는 장차 체결되는 계약에 의해 제공할 재화 또는 용역의 내용을 변경할 수 있습니다. 이 경우에는 변경된 재화
					...
					<li>&nbsp;&nbsp;② “소프트엔지니어소사이어티”가 제3자에게 구매자 개인정보를 제공·위탁할 필요가
						있는 경우 실제 구매신청 시 구매자의 동의를 받아야 하며, 회원가입 시 미리 포괄적으로 동의를 받지 않습니다. 이 때
						“소프트엔지니어소사이어티”는 제공되는 개인정보 항목, 제공받는 자, 제공받는 자의 개인정보 이용 목적 및 보유‧이용
						기간 등을 구매자에게 명시하여야 합니다. 다만 「정보통신망이용촉진 및 정보보호 등에 관한 법률」 제25조 제1항에 의한
						개인정보 취급위탁의 경우 등 관련 법령에 달리 정함이 있는 경우에는 그에 따릅니다.</li>
					<li>&nbsp;</li>
					<li>&nbsp;</li>
					<li>제10조 (계약의 성립)</li>
					<li>&nbsp;</li>
