...
<script>
function ilist(page){
    location.href="/edu/community/media_in_it.do?curPage="+page+"&searchOption=${map.searchOption}"+"&keyword=${map.keyword}";
}

function goBoardDetail(seq){
	location.href="/edu/community/media_in_it_detail.do?seq="+seq;
}
...
function search(){
	  ...
	  location.href="/edu/community/media_in_it.do?searchOption="+searchoption+"&keyword="+searchword;
}
...
.top_img {
    position: relative;
    background-image: url(/resources/segroup/society/edu/image/main/top_img/top_img_mediainit.jpg);                                                               
    height: 250px;
...
<body>
    ...
    <div class="top_img">
        <div class="top_img_text">
            <p class="top_img_text1">미디어에서 만나는 Soft Engineer Society</p>
            <p class="top_img_text2">Soft Engineer Society에 대한 다양한 미디어 이야기</p>
        </div>
    </div>
...
<!--   		</div> -->
			<table>
               ...
               <tr class="notice_top">
					...
					<td style="text-align: left;"><a href="javascript:goBoardDetail('${data.board_content_seq}')"> <c:out value="${data.board_content_title}"/></a></td>
				...
				<!-- <tr class="notice_top">
					<td class="notice_icon1">2017-07-25</td>
					<td><a href="">ICT 교육센터 졸업1기.</a></td>
					<td>홍길동</td>
					<td>30</td>
				</tr>
				<tr>
					<td class="notice_icon2">2017-07-25</td>
					<td><a href="">ICT 교육센터 졸업1기.</a></td>
					<td>홍길동</td>
					<td>30</td>
				</tr>
				<tr>
					<td class="notice_icon3">2017-07-25</td>
					<td><a href="">ICT 교육센터 졸업1기.</a></td>
					<td>홍길동</td>
					<td>30</td>
				</tr>
