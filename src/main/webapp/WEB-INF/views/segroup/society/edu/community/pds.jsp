...
<script>
function ilist(page){
    location.href="/edu/community/pds.do?curPage="+page+"&searchOption=${map.searchOption}"+"&keyword=${map.keyword}";
}

function goBoardDetail(seq){
	location.href="/edu/community/pds_detail.do?seq="+seq;
}
...
function search(){
	  ...
	  location.href="/edu/community/pds.do?searchOption="+searchoption+"&keyword="+searchword;
}
...
.top_img {
    position: relative;
    background-image: url(/resources/segroup/society/edu/image/main/top_img/top_img_pds.jpg);                                                               
    height: 250px;
...
<body>
    ...
    <div class="top_img">
        <div class="top_img_text">
            <p class="top_img_text1">자료실</p>
            <p class="top_img_text2">운영하고 있는 과정들의 다양한 정보들!</p>
        </div>
    </div>
