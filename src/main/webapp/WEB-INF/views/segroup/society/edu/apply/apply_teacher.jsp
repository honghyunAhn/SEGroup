...
<div class="sub_m_contents">
	<div class="major_study">
		<h1>과목별 보기</h1>
			<ul>
				<li><a href="">IT 교수진</a></li>
				<li><a href="">일본어 교수진</a></li>
				<li><a href="">진로상담팀</a></li>
				<li><a href="">취업지원팀</a></li>
			</ul>
	</div>
	<div class="major_teacher"><h2>IT 교수진</h2></div>
	<div class="info_4_m">
	...
	<div class="major_teacher"><h2>일본어 교수진</h2></div>
	<div class="info_4_m">
		<h2><p>교수님 사진<span>더보기<img src="<c:url value="/resources/segroup/society/edu/image/sub/plus.png" />" alt=""/></span></p></h2>
		<div class="box_wrap">
		    <div class="box box_left">
	...
	<div class="major_teacher"><h2>상담팀</h2></div>
	<div class="info_4_m">
		<h2><p>교수님 사진<span>더보기<img src="<c:url value="/resources/segroup/society/edu/image/sub/plus.png" />" alt=""/></span></p></h2>
		<div class="box_wrap">
		    <div class="box box_left">
