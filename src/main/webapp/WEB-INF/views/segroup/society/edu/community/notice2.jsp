...
<script>
function ilist(page){
    location.href="/edu/community/notice2.do?curPage="+page+"&searchOption=${map.searchOption}"+"&keyword=${map.keyword}";
}

function goBoardDetail(seq){
	location.href="/edu/community/notice2_detail.do?seq="+seq;
}
...
function search(){
	  ...
	  location.href="/edu/community/notice2.do?searchOption="+searchoption+"&keyword="+searchword;
}
...
.top_img {
    position: relative;
    background-image: url(/resources/segroup/society/edu/image/main/top_img/top_img_notice.jpg);                                                               
    height: 250px;
...
<body>
    ...
    <div class="top_img">
        <div class="top_img_text">
            <p class="top_img_text1">재학생 공지사항</p>
