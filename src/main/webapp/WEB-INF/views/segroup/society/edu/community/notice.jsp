...
<script>
function ilist(page){
    location.href="/edu/community/notice.do?curPage="+page+"&searchOption=${map.searchOption}"+"&keyword=${map.keyword}";
}

function goBoardDetail(seq){
	location.href="/edu/community/notice_detail.do?seq="+seq;
}
...
function search(){
	  ...
	  location.href="/edu/community/notice.do?searchOption="+searchoption+"&keyword="+searchword;
}
