	...
	<div class="sub_m_contents">
		<div class="main_top_slidewrap">
			...
			<table id="infotb" class="indent">
				...
				<tr>
					<td>∘ 교육대상</td>
					<td>38기 SC IT마스터 중 일본어 자격증 미취득자</td>
				</tr>
				<tr>
					<td>∘ 일시</td>
					<td>1~2월 중 매주 "토" 3시간 총 24시간(8회 학습보장)</td>
				</tr>
				<tr>
					<td>∘ 장소</td>
			...
			<table id="currtb" class="indent">
				...
				<tr>
					<td>1월~2월</td>
					<td rowspan="2" style="text-align: center;">매주 토요일 10시~13시(8회 학습보장)</td>
					<td style="text-align: left;">
						1. 문제유형 개념정리<br>
						2. 문제 유형별 풀이방법(스킬) 반복지도<br>
						3. 과제 : 모의고사 제공<br>
						4. 채점 및 결과 피드백<br>
						- 취약파트에 대한 풀이 강도 UP
					</td>
