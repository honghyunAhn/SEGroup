...
jQuery(document).ready(function(){  
	...
	if('${mobileVerification[6]}'=='1'){ // 성별 설정
		...
		$('#user_sex_m',opener.document).removeClass('btn_gray btn_fore_black');
		$('#user_sex_m',opener.document).addClass('btn_b');
		$('#user_sex_f',opener.document).removeClass('btn_b');
		$('#user_sex_f',opener.document).addClass('btn_gray btn_fore_black');
	}else{
		$('#user_sex',opener.document).val('A0001');
		$('#veriGender',opener.document).val('A0001');
		$('#user_sex_f',opener.document).removeClass('btn_gray btn_fore_black');
		$('#user_sex_f',opener.document).addClass('btn_b');
		$('#user_sex_m',opener.document).removeClass('btn_b');
		$('#user_sex_m',opener.document).addClass('btn_gray btn_fore_black');
	}
