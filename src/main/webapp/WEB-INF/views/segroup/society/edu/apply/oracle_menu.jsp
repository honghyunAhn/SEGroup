ㅍㅍㅍㅍㅍㅍㅍㅍㅍㅍ<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
...
<script type="text/javascript">
	function goCrcDetail(gisu_seq) {
		location.href = "/edu/apply/oracle_detail?gisu_seq=" + gisu_seq;
	}
...
.top_img {
    position: relative;
    background-image: url(/resources/segroup/society/edu/image/main/top_img/top_img_oracle.jpg);                                                               
    height: 250px;
...
<body>
    ...
    <div class="top_img">
        <div class="top_img_text">
            <p class="top_img_text1">Oracle</p>
            <p class="top_img_text2">오라클 전문가로 향하는 가장 빠른 길!</p>
        </div>
    </div>
