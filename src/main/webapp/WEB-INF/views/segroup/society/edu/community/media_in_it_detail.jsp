...
<script>
	...
	function goToNear(seq, nearType) {
		location.href = "/edu/community/media_in_it_detail.do?seq=" + seq + "&searchOption=" + nearType;
	}

	function goToList() {
		location.href = "/edu/community/media_in_it.do";
	}
</script>
<style>
.top_img {
	position: relative;
	background-image:
		url(/resources/segroup/society/edu/image/main/top_img/top_img_mediainit.jpg);
	height: 250px;
