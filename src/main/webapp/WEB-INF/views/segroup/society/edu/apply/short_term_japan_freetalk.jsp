...
<body ng-app="myapp">
	...
	<div class="sub_m_contents">
		<div class="main_top_slidewrap">
			...
			<div class="spacing50"></div>
			<div class="indent">
			<h2 align="center"  style="color:red;">본 과정은 SC IT마스터 전용과정으로 일반인들은 지원하실 수 없는점 양해 부탁드립니다.</h2></div>
			<div class="spacing50"></div>
			<h3>∘ 강좌안내</h3>
			<div class="indent">
			...
			<table id="infotb" class="indent">
				...
				<tr>
					<td>∘ 교육대상</td>
					<td>37기, 38기 SC IT마스터 학생 (38기는 토요일만 교육)</td>
				</tr>
				<tr>
					<td>∘ 일시</td>
			...
			<table id="currtb" class="indent">
				...
				<tr>
					<td>1월~2월</td>
					<td rowspan="2" style="text-align: center;">9시~17시중(38기는 토요일만 교육)</td>
