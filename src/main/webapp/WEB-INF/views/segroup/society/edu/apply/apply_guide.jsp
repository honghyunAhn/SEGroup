...
<div class="sub_m_contents">
	<div class="main_top_slidewrap">
		...
		<div class="master_bottom_menu">
			<ul>
				<li class="choice_menu mbm1"><a href="#app_01">과정개요</a></li>
				<li class="mbm2"><a href="#app_02">커리큘럼</a></li>
				<li class="mbm3"><a href="#app_03">학사관리</a></li>
				<li class="mbm4"><a href="#app_04">강사진</a></li>
				<li class="mbm5"><a href="#app_05">진출분야</a></li>
				<li class="mbm6"><a href="#app_06">수강문의</a></li>
			</ul>
		</div>
		<div class="master_bottom_contents">
			<div class="info1" id="app_01">과정개요 정보</div>
			<div class="info2" id="app_02">커리큘럼 정보</div>
			<div class="info3" id="app_03">학사관리 정보</div>
			<div class="info4" id="app_04">
				<ul>
					<li>
						<dl>
							<dt>
							...
							<dd>
									<img src="<c:url value="/resources/segroup/society/edu/image/sub/img_teacher.png" />">
							</dd>
						</dl>
								<p>Java 기초</p>
								<p>처음부터 쉽게 쉽게</p>
			...
			<div class="info5" id="app_05">진출분야</div>
			<div class="info6" id="app_06">
				<dl>
					<dt>
						<h1>상담받으실 연락 정보</h1>
