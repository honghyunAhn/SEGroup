...
<body>
    ...
    <div class="container_rainbow">
        ...
        <div class="content sub-content sub05_content" id="main">
            ...
            <div class="section section_sub05-01">
            <form  action="/smtp/user/sub05-04-01-submit" method="post" id="refund_form" class="formStyle" style="text-align: center;">
				...
				<div class="d-flex">
					...
					<input type="text" class="input" style="width:60%;" id="account" name="account" placeholder="계좌번호를 입력하세요.">
				</div>
				<div class="d-flex">
				...
				<div class="">
					<input type="button" id="refund_submit" class="button btn-pColor" style="height:30px;" value="환불신청">
				</div>
            </form>
            </div>
        </div>
