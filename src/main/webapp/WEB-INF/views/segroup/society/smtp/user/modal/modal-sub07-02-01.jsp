...
<div class="container_rainbow">
	<div class="content sub-content view-receipt" id="main">
        ...
        <div class="button-wrap d-flex justify_end margin-top20">
            <button class="btn_normal btn_pp_bg btn_large btn-printReceipt" type="button" onclick="printWindow()">출력하기</button>
        </div>
    </div>
</div>
</body>
