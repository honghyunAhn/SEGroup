...
<head>
    ...
    <script src="<c:url value="/resources/segroup/society/smtp/js/resumeForm.js" />"></script>
    <script src="https://t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
    <script type="text/javascript">
        var user_sex = "${detail.user_sex }";
    	var endDt = "${app_end_date}";
    	$(function(){
...
<body ng-app="myApp">
    <div class="container_rainbow container-apply bgc_eee">
        ...
        <div class="content course-apply course-point06" id="main">
                <div class="course-applyContainer d-flex apply01-01">
                    <div class="resumeSection">
                        <!-- 지원하기 버튼 2개여서, input type submit사용 안함 -->
                        <form action="/smtp/apply/insert" name="resume" id="resumeForm" method="post"
                            enctype="multipart/form-data">
                            <!-- <form action="/smtp/apply/insert" name="resume" id="resumeForm" method="post" onsubmit="return formCheck();" enctype="multipart/form-data"> -->
                            <input type="hidden" name="app_end_date" value="${app_end_date }" />
                            <input type="hidden" name="gisu_id" value="${gisu_id}" />
                            <input type="hidden" name="crc_id" value="${crc_id }" />
                            <input type="hidden" name="user_id" value="${detail.user_id }" />
                            <input type="hidden" name="stu_app_ins_id" value="${detail.user_id }" />
                            <input type="hidden" name="stu_app_udt_id" value="${detail.user_id }" />
                            <input type="hidden" name="stu_app_nm" value="${detail.user_nm }">
                            <input type="hidden" name="stu_app_birth" value="${detail.user_birth }">
                            <input type="hidden" name="stu_app_gender" value="${detail.user_sex }">

                            <!-- ● div.resumeHeader 추가  -->
                            <div class="resumeHeader">
                                <h2 class="h2">${gisu_nm} 지원서</h2>
                                <div class="resumeMsg">
                            ...
                            <div class="resumeWrap rsm_profile">
                                <div class="resumeTitle d-flex">
                                    <h3 class="h3">기본정보</h3>
                                    <p class="fc_999">담당자가 연락하는 이메일과 휴대폰 정보가 올바르게 입력되어 있는지 확인하세요.</p>
                                </div>
                                    ...
                                    <div class="resumePhotoWrap">
                                        ...
                                        <div class="imgBtnWrap d-flex">
                                            <div class="imgBtn addImg">
                                                <input type="file" name="stu_app_photo_file" id="resumePhoto"
                                                    class="resumePhoto addImg">
                                    ...
                                    <div class="resumeFormWrap">
                                        <div class="resumeForm row d-flex">
                                            <div class="resumeForm_text resumeForm_load form33">
                                                ...
                                                <div class="rsm_input" id="stu_app_nm">${detail.user_nm }</div>
                                            </div>
                                            <div class="resumeForm_text resumeForm_load form33">
                                                <div class="rsm_label">생년월일<strong class="cRed">＊</strong></div>
                                                <div class="rsm_input" id="stu_app_birth">${detail.user_birth }</div>
                                            </div>
                                            <div class="resumeForm_text resumeForm_load form33">
                                                ...
                                                <div class="rsm_txt">
                                                    ...
                                                    <div class="rsmForm_addressDiv d-flex justify_between">
                                                        <input type="text" class="rsm_input loadAddress" id="zipcode"
                                                            name="stu_app_zipcode" placeholder="우편번호"
                                                            style="cursor:default;" readonly>
                                                        <input type="text" class="rsm_input loadAddress" id="address"
                                                            name="stu_app_addr" placeholder="주소" style="cursor:default;"
                                                            readonly>
                                                        <input type="text" class="rsm_input " id="addressDetail"
                                                            name="stu_app_addr_detail" placeholder="상세주소를 입력하세요.">
                                                    </div>
                                                </div>
                                                <!-- 우편번호 검색 기능 넣기 -->
                                        ...
                                        <div class="resumeForm row d-flex">
                                            <div class="resumeForm_text form33">
                                                <label for="" class="rsm_label">휴대전화<strong
                                                        class="cRed">＊</strong></label>
                                                <input type="text" class="rsm_input" name="stu_app_phone"
                                                    value="${detail.user_phone }" type="number" pattern="[0-9]*"
                                                    maxlength="11" autocomplete="off">
                                            </div>
                                            <div class="resumeForm_text form33">
                                                <label for="" class="rsm_label">비상연락처</label>
                                                <input type="text" class="rsm_input" name="stu_app_em_phone"
                                                    type="number" pattern="[0-9]*" value="" maxlength="11"
                                                    autocomplete="off">
                                            </div>
                                            <div class="resumeForm_text form33">
                                            ...
                                            <div class="resumeFormWrap">
                                                <div class="resumeForm row d-flex">
                                                    <div class="resumeForm_text form20">
                                                        ...
                                                        <input type="text" class="rsm_input edu_sc_nm edu_input"
                                                            name="eduHistoryList[0].stu_app_edu_sc_nm"
                                                            autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form20">
                                                        <div class="rsm_label">전공계열<strong class="cRed">＊</strong></div>
                                                        <select class="rsm_selectBox edu_field edu_input"
                                                            name="eduHistoryList[0].stu_app_edu_field">
                                                    ...
                                                    <div class="resumeForm_text form20">
                                                        ...
                                                        <input type="text" class="rsm_input edu_major edu_input"
                                                            name="eduHistoryList[0].stu_app_edu_major"
                                                            autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form20">
                                                        <div class="rsm_label">졸업상태<strong class="cRed">＊</strong></div>
                                                        <select class="rsm_selectBox edu_gd_ck edu_input"
                                                            name="eduHistoryList[0].stu_app_edu_gd_ck"
                                                            onchange="gd_ck_change(this)">
                                                            <option value="" selected="selected">선택</option>
                                                    ...
                                                    <div class="resumeForm_text form20">
                                                        <div class="rsm_label gd_label">졸업일<strong
                                                                class="cRed">＊</strong></div>
                                                        <input type="text" class="rsm_input edu_gd_dt edu_input"
                                                            name="eduHistoryList[0].stu_app_edu_gd_dt"
                                                            id="stu_app_eduHistory_dt_0" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="resumeForm row d-flex">
                                                    <div class="resumeForm_text form20">
                                                        <div class="rsm_label">소재지<strong class="cRed">＊</strong></div>
                                                        <input type="text" class="rsm_input edu_sc_lo edu_input"
                                                            name="eduHistoryList[0].stu_app_edu_sc_lo"
                                                            autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form80">
                                                        <label for="loadAdress"
                                                            ...
                                                            <span>졸업요건</span>
                                                            <span class="cRed h5">졸업예정자의 "졸업요건"은 현재 학적사항 및 연수기간 내 졸업가능
                                                                여부를 확인하기 위함입니다. 모든 졸업요건을 충족하고 졸업을 미룬 경우는 졸업상태 "유예"를
                                                                선택하세요.</span>
                                                        </label>
                                                        <input type="text" class="rsm_input edu_gd_rq"
                                                            name="eduHistoryList[0].stu_app_edu_gd_rq"
                                                            placeholder="1) 미 이수 학점 있을 경우 : 잔여학점 00학점(이수계획 기재) / 2) 그 외 졸업기준 미달성 시 : 졸업기준 학점 이수완료(졸업기준 기재)"
                                                            autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="resumeWrap rsm_career" id="rsm_career" name="matchLink">
                                <div class="resumeTitle d-flex">
                                    <h3 class="h3">경력사항</h3>
                                    <p class="fc_999">최근 경력순으로 입력하세요.</p>
                                </div>
                                <div class="resumeSection">
                                    <div class="resumeFormContainer">
                                        <div class="resumeFormWrapper" id="test">
                                            ...
                                            <div class="resumeFormWrap">
                                                ...
                                                <div class="resumeForm row d-flex">
                                                    <div class="resumeForm_text form25">
                                                        <div class="rsm_label">입사일</div>
                                                        <input type="text" class="rsm_input crr_st"
                                                            id="stu_app_crr_frm_0" name="careerList[0].stu_app_crr_st"
                                                            autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form25">
                                                        <div class="rsm_label">퇴사일</div>
                                                        <input type="text" class="rsm_input crr_et"
                                                            id="stu_app_crr_end_0" name="careerList[0].stu_app_crr_et"
                                                            autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form50">
                                                        <div class="rsm_label">담당업무</div>
                                                        <input type="text" class="rsm_input crr_description"
                                                            name="careerList[0].stu_app_crr_description"
                                                            autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="resumeForm row d-flex">
                                                    <div class="resumeForm_text form25">
                                                        ...
                                                        <input type="text" class="rsm_input study_nm"
                                                            name="studyList[0].stu_app_study_nm" autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form25">
                                                        <div class="rsm_label">시작일</div>
                                                        <input type="text" class="rsm_input study_st"
                                                            id="stu_app_study_frm_0"
                                                            name="studyList[0].stu_app_study_st" autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form25">
                                                        <div class="rsm_label">종료일</div>
                                                        <input type="text" class="rsm_input study_et"
                                                            id="stu_app_study_end_0"
                                                            name="studyList[0].stu_app_study_et" autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form25">
                                                        <div class="rsm_label">교육기관명</div>
                                                        <input type="text" class="rsm_input study_ag"
                                                            name="studyList[0].stu_app_study_ag" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="resumeForm row d-flex">
                                                    <div class="resumeForm_text form100">
                                                        ...
                                                        <input type="text" class="rsm_input study_detail"
                                                            name="studyList[0].stu_app_study_detail" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="resumeWrap rsm_language" id="rsm_language" name="matchLink">
                                <div class="resumeTitle d-flex">
                                    <h3 class="h3">언어능력</h3>
                                    <p class="fc_999">최근 취득일자순으로 입력하세요.</p>
                                </div>
                                <div class="resumeSection">
                                    <div class="resumeFormContainer">
                                        <div class="resumeFormWrapper">
                                            ...
                                            <div class="resumeFormWrap">
                                                <div class="resumeForm row d-flex">
                                                    <div class="resumeForm_text form20">
                                                        ...
                                                        <select class="rsm_selectBox lang_test_nm"
                                                            name="languageList[0].stu_app_lang_test_nm">
                                                            <option value="" selected="selected">선택</option>
                                                    ...
                                                    <div class="resumeForm_text form20">
                                                        ...
                                                        <input type="text" class="rsm_input lang_grade"
                                                            name="languageList[0].stu_app_lang_grade"
                                                            autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form20">
                                                        <div class="rsm_label">발급기관</div>
                                                        <input type="text" class="rsm_input lang_ag"
                                                            name="languageList[0].stu_app_lang_ag" autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form20">
                                                        <div class="rsm_label">취득일자</div>
                                                        <input type="text" class="rsm_input lang_obtain_dt"
                                                            id="stu_app_lang_dt_0"
                                                            name="languageList[0].stu_app_lang_obtain_dt"
                                                            autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form20">
                                                        <div class="rsm_label">비고</div>
                                                        <input type="text" class="rsm_input lang_note"
                                                            name="languageList[0].stu_app_lang_note" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="resumeFormWrap">
                                                <div class="resumeForm row d-flex">
                                                    <div class="resumeForm_text form25">
                                                        ...
                                                        <select class="rsm_selectBox license_nm"
                                                            name="licenseList[0].stu_app_license_nm">
                                                            <option value="" selected="selected">선택</option>
                                                    ...
                                                    <div class="resumeForm_text form25">
                                                        ...
                                                        <input type="text" class="rsm_input license_ag"
                                                            name="licenseList[0].stu_app_license_ag" autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form25">
                                                        <div class="rsm_label">취득일자</div>
                                                        <input type="text" class="rsm_input license_obtain_dt"
                                                            id="stu_app_license_dt_0"
                                                            name="licenseList[0].stu_app_license_obtain_dt"
                                                            autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form25">
                                                        <div class="rsm_label">비고</div>
                                                        <input type="text" class="rsm_input license_note"
                                                            name="licenseList[0].stu_app_license_note"
                                                            autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="resumeWrap rsm_participation" id="rsm_participation" name="matchLink">
                                <div class="resumeTitle d-flex">
                                    ...
                                    <p class="fc_999">본 과정 응시여부를 선택하세요. (SMART Cloud IT마스터 포함) </p>
                                </div>
                                <div class="resumeSection">
                                    <div class="resumeFormContainer">
                                        <div class="resumeFormWrapper">
                                                    ...
                                                    <div class="resumeForm_text form33">
                                                        ...
                                                        <div class="rsm_input d-flex">
                                                            <label for="participation1" class="rsm_radio">
                                                                <input type="radio" class="ses_ck"
                                                                    name="sesList[0].stu_app_ses_ck" value="B0700"
                                                                    onchange="ses_ck_change(this)" id="participation1">
                                                                <code value="B0700"></code>
                                                            </label>
                                                            <label for="participation2" class="rsm_radio">
                                                                <input type="radio" class="ses_ck"
                                                                    name="sesList[0].stu_app_ses_ck" value="B0701"
                                                                    onchange="ses_ck_change(this)" id="participation2">
                                                                <code value="B0701"></code>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="resumeForm_text form33">
                                                        <div class="rsm_label">지원일<strong class="cRed">＊</strong></div>
                                                        <input type="text" class="rsm_input ses_dt"
                                                            id="stu_app_ses_dt_0" name="sesList[0].stu_app_ses_apply_dt"
                                                            autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form33">
                                                        ...
                                                        <input type="text" class="rsm_input ses_rt"
                                                            name="sesList[0].stu_app_ses_apply_rt" placeholder="합격/불합격"
                                                            autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="resumeWrap rsm_kmove" id="rsm_kmove" name="matchLink">
                                <div class="resumeTitle d-flex">
                                    ...
                                    <p class="fc_999">한국산업인력공단의 해외취업 연수과정 참여여부를 선택하세요.</p>
                                </div>
                                <div class="resumeSection">
                                    <div class="resumeFormContainer">
                                        <div class="resumeFormWrapper">
                                                ...
                                                <div class="resumeForm row d-flex">
                                                    <div class="resumeForm_text form20">
                                                        ...
                                                        <div class="rsm_input d-flex">
                                                            <label for="kmove1" class="rsm_radio">
                                                                <input type="radio" class="kmove_ck"
                                                                    name="kmoveList[0].stu_app_kmove_ck" value="B0900"
                                                                    onchange="kmove_ck_change(this)" id="kmove1">
                                                                <code value="B0900"></code>
                                                            </label>
                                                            <label for="kmove2" class="rsm_radio">
                                                                <input type="radio" class="kmove_ck"
                                                                    name="kmoveList[0].stu_app_kmove_ck" value="B0901"
                                                                    onchange="kmove_ck_change(this)" id="kmove2">
                                                    ...
                                                    <div class="resumeForm_text form20">
                                                        ...
                                                        <input type="text" class="rsm_input kmove_nm"
                                                            name="kmoveList[0].stu_app_kmove_nm" autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form20">
                                                        <div class="rsm_label">운영기관<strong class="cRed">＊</strong></div>
                                                        <input type="text" class="rsm_input kmove_ag"
                                                            name="kmoveList[0].stu_app_kmove_ag" autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form20">
                                                        <div class="rsm_label">시작일<strong class="cRed">＊</strong></div>
                                                        <input type="text" class="rsm_input kmove_st"
                                                            id="stu_app_kmove_frm_0"
                                                            name="kmoveList[0].stu_app_kmove_st" autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form20">
                                                        <div class="rsm_label">종료일<strong class="cRed">＊</strong></div>
                                                        <input type="text" class="rsm_input kmove_et"
                                                            id="stu_app_kmove_end_0"
                                                            name="kmoveList[0].stu_app_kmove_et" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="resumeWrap rsm_experience" id="rsm_experience" name="matchLink">
                                <div class="resumeTitle d-flex">
                                    ...
                                    <p class="fc_999">과거 해외연수 경험여부를 선택하세요.</p>
                                </div>
                                <div class="resumeSection">
                                    <div class="resumeFormContainer">
                                        <div class="resumeFormWrapper">
                                            ...
                                            <div class="resumeFormWrap">
                                                <div class="resumeForm row d-flex">
                                                    <div class="resumeForm_text form20">
                                                        <div class="rsm_label">해외연수 경험 여부</div>
                                                        <div class="rsm_input d-flex">
                                                            <label for="experience1" class="rsm_radio">
                                                                <input type="radio" class="overseas_ck"
                                                                    name="overseasList[0].stu_app_overseas_ck"
                                                                    value="B0800" onchange="overseas_ck_change(this)"
                                                                    id="experience1">
                                                            ...
                                                            <label for="experience2" class="rsm_radio">
                                                                <input type="radio" class="overseas_ck"
                                                                    name="overseasList[0].stu_app_overseas_ck"
                                                                    value="B0801" onchange="overseas_ck_change(this)"
                                                                    id="experience2">
                                                    ...
                                                    <div class="resumeForm_text form20">
                                                        <div class="rsm_label">국가명</div>
                                                        <input type="text" class="rsm_input overseas_nm"
                                                            name="overseasList[0].stu_app_overseas_nm"
                                                            autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form20">
                                                        <div class="rsm_label">시작일</div>
                                                        <input type="text" class="rsm_input overseas_st"
                                                            id="stu_app_overseas_frm_0"
                                                            name="overseasList[0].stu_app_overseas_st"
                                                            autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form20">
                                                        <div class="rsm_label">종료일</div>
                                                        <input type="text" class="rsm_input overseas_et"
                                                            id="stu_app_overseas_end_0"
                                                            name="overseasList[0].stu_app_overseas_et"
                                                            autocomplete="off">
                                                    </div>
                                                    <div class="resumeForm_text form20">
                                                        <div class="rsm_label">목적</div>
                                                        <input type="text" class="rsm_input overseas_purpose"
                                                            name="overseasList[0].stu_app_overseas_purpose"
                                                            autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="resumeWrap rsm_introduction" id="rsm_introduction" name="matchLink">
                                <div class="resumeTitle d-flex">
                                    ...
                                    <p class="fc_999">지원동기, 성장과정, 성격, 가치관 및 특이사항 등을 자유롭게 기술하세요.</p>
                                </div>
                                <div class="resumeSection">
                                    <div class="resumeFormContainer">
                                        <div class="resumeFormWrapper">
                                            ...
                                            <div class="resumeFormWrap">
                                                <div class="resumeForm row">
                                                    <div class="resumeForm_text form100">
                                                        <input type="text"
                                                            class="rsm_input introduce_title introduce_input"
                                                            name="introduceList[0].stu_app_introduce_title"
                                                            placeholder="제목입력" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="resumeForm row">
                                                    <textarea class="rsm_textarea introduce_detail introduce_input"
                                                        name="introduceList[0].stu_app_introduce_detail"
                                                        placeholder="내용입력" rows="8" cols="80"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="resumeWrap rsm_evidence" id="rsm_evidence" name="matchLink">
                                <div class="resumeTitle d-flex">
                                    ...
                                    <p class="fc_999">파일명 : 항목_이름(ex : 최종학력증명서_홍길동, 고용보험상실내역확인_홍길동)</p>
                                </div>
                                <div class="resumeSection">
                                    <div class="resumeFormContainer">
                                        <div class="resumeFormWrapper necessary">
                                            <div class="resumeForm_noticeWrap d-flex">
                                                <div class="resumeForm_notice">
                                                    <ul class="rsm_noticeList">
                                                        ...
                                                        <li>
                                                            - (졸예자, 유예자 중) 상기의 서류가 제출 불가능할 경우(수료증명서 포함)<br>&nbsp; :
                                                            학적상태를 증명할 수 있는 서류 제출(졸업요건, 달성상태기재, 학교 직인필수)
                                                        </li>
                                                    </ul>
                                                    <ul class="rsm_noticeList">
                                                        <li>
                                                        ...
                                                        <li class="cRed">
                                                            ※ 본인의 이름과 주민번호 앞 6자리, “고용보험조회 내역이 없습니다”라는 문구가 명확히 보이도록
                                                            캡쳐해주시기 바랍니다.
                                                        </li>
                                                        <li class="cRed">
                                                ...
                                                <div class="resumeForm row d-flex">
                                                    <div class="resumeForm_text form25">
                                                        ...
                                                        <div class="rsm_fileUpload">
                                                            <span>파일 선택</span>
                                                            <input type="file" name="stu_app_edu_file"
                                                                id="resumeEvidence1" class="resumeEvidence_file">
                                                        </div>
                                                        <input type="text" class="resumeEvidence_url"
                                                            id="resumeEvidence1_url" readonly placeholder="최종학력증명서_홍길동">
                                                    </div>
                                                    <div class="resumeForm_text form25">
                                                        <div class="rsm_label">고용보험 상실내역 확인서</div>
                                                        <div class="rsm_fileUpload">
                                                            <span>파일 선택</span>
                                                            <input type="file" name="stu_app_isr_file"
                                                                id="resumeEvidence2" class="resumeEvidence_file">
                                                        </div>
                                                        <input type="text" class="resumeEvidence_url"
                                                            id="resumeEvidence2_url" readonly
                                                            placeholder="고용보험 상실내역 확인서_홍길동">
                                                    </div>
                                                    <div class="resumeForm_text form25">
                                                        <div class="rsm_label">출입국 사실증명서</div>
                                                        <div class="rsm_fileUpload">
                                                            <span>파일 선택</span>
                                                            <input type="file" name="stu_app_imm_file"
                                                                id="resumeEvidence3" class="resumeEvidence_file">
                                                        </div>
                                                        <input type="text" class="resumeEvidence_url"
                                                            id="resumeEvidence3_url" readonly
                                                            placeholder="출입국 사실증명서_홍길동">
                                                    </div>
                                                    <div class="resumeForm_text form25">
                                                        <div class="rsm_label">워크넷 직무평가 결과</div>
                                                        <div class="rsm_fileUpload">
                                                            <span>파일 선택</span>
                                                            <input type="file" name="stu_app_worknet_file"
                                                                id="resumeEvidence4" class="resumeEvidence_file">
                                                        </div>
                                                        <input type="text" class="resumeEvidence_url"
                                                            id="resumeEvidence4_url" readonly
                                                            placeholder="워크넷 직무평가 결과_홍길동">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="section_btnWrap">
                                    <div class="resumeMsg">※ 지원기간 중에는 언제든 수정이 가능합니다.</div>
                                    <!-- <input type="submit" class="button resumeBtn h2" value="지원하기"> -->
                                    <div class="btn_normal resumeBtn">지원하기</div>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="resumeAside">
                        <nav class="resumeNav">
                            ...
                            <div class="resumeNav_button resumeBtn">지원하기</div>
                        </nav>
                    </div>
                </div>
            </div>
