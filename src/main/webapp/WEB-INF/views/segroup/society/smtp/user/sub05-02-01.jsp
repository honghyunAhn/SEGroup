			...
			$.ajax({
				...
				success	: function(data) {
					...
					if(now <= end_date && data == "1") {
						var str = '<div class="resumeMsg cRed"><strong>※ 지원기간 중에는 언제든 수정이 가능합니다.</strong></div>';
						str += '<div class="button resumeBtn h2">수정하기</div>';
						$('#modifyBtn').html(str);
					}
...
<!--                                     <div class="imgGuide"></div> -->
                                    <div class="imgHere">
                                    	<img class="stu_photo_img" alt="" src='<c:url value="/stu/apply/photo/${apply.user_id}_${apply.gisu_id }/${apply.stu_app_photo_saved }" />' width="150px" height="200px">
                                    </div>
                                </div>
