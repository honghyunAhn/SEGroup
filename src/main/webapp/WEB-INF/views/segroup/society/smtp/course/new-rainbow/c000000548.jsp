...
<head>
    ...
    <script type="text/javascript">
    	...
    	$(function() {
    		class_time("${courseInfo.CLASS_DAY}", "${courseInfo.CLASS_START_TIME}", "${courseInfo.CLASS_END_TIME}")
    		graduation("${courseInfo.LEARN_END_DATE}");
    	});
    	
    	//교육기간(요일, 시간)
    	function class_time(class_day, class_start_time, class_end_time){
    		const change_week = class_day.replaceAll(",","/");
    		const tmp = change_week + "&nbsp;&nbsp;&nbsp;" + class_start_time + " ~ " + class_end_time;
    		$("#learnTime").html(tmp);
    	}
                            ...
                            <div class="course-section">
                                <div class="course-infoTable">
                                    <div class="d-flex">
                                        ...
                                        <ul class="infoTd">
                                            <li>${courseInfo.APP_START_DATE} ~ ${courseInfo.APP_END_DATE}</li>
                                        </ul>
                                    </div>
                                    <div class="d-flex jus">
                                        ...
                                        <ul class="infoTd">
                                            <li>${courseInfo.LEARN_START_DATE} ~ ${courseInfo.LEARN_END_DATE}</li>
                                            <li id="learnTime"></li>
                                        </ul>
                                    </div>
                                    <div class="d-flex">
