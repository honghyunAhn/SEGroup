                                        ...
                                        <ul class="infoTd">
                                            ...
                                            <li>
                                                1. MOU 대학교 추천(대학교 추천서 제출 시) : <span
                                                    class="course-price"><span class="expenses"></span>원</span>→
                                                <span class="mou_price"></span>원
                                            </li>
                                            <li>
                                                2. 코딩챌린지(사전학습반) 과정 수료 : <span class="course-price"><span class="expenses"></span>원</span>→
                                                <span class="etc_price"></span>원
                                            </li>
                                            <li>
                                                3. 기타 협약기관 추천 : <span class="course-price"><span class="expenses"></span>원</span>→
                                                <span class="etc_price"></span>원
                                            </li>
                                            <li class="fc_999">
