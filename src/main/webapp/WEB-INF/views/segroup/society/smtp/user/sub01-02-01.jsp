    ...
    <div class="container_rainbow">
        ...
        <div class="content sub-content sub01_content" id="main">
            ...
            <ul class="processWrap d-flex">
                ...
                <li class="process active"><span class="margin-right10">02</span>정보입력</li>
                <li class="process"><span class="margin-right10">03</span>가입완료</li>
            </ul>
            <div class="section section_sub01-02-01">
                ...
                <!-- 2) 회원가입 - 2단계) 정보입력 -->
                <form action="/smtp/user/joinMember" id="saveForm" class="formStyle join" method="post" onsubmit="return formCheck();">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="retrieve user-sex d-flex">
                        	...
                        	<label><input type="radio" name="gender" value="A0001"> 여자</label>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="userID d-flex">
                            <input class="input" type="text" id="id" name="id" maxlength="12" value="${user.id}" autocomplete="off">
                            <button class="btn_normal input-btn btn_pp" type="button" id="checkDuplId">중복확인</button>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="userPw d-flex">
	                        <input class="input" type="password" id="pw" name="pw" maxlength="20" autocomplete="off">
	                        <span class="explan">&nbsp;※ 영문, 숫자, 특수 기호(!, @, # 등)을 모두 사용하여 최소 8자이상</span>
                        </div>
                    </div>
                    <div class="d-flex">
                        <label class="label" for="userPwCheck">* 비밀번호확인</label>
                        <div class="userPwCheck d-flex">
                            <input class="input" type="password" id="pw_confirm" name="pw_confirm" maxlength="20" autocomplete="off">
                        </div>
                    </div>
                    <div class="d-flex">
                        <label class="label" for="email01">* 이메일</label>
                        <div class="email d-flex">
                            <input class="input email01" type="text" id="email1" autocomplete="off">
                            <span>&nbsp;@&nbsp;</span>
                            <input class="input email02" type="text" id="email2" autocomplete="off">
                            <!-- 이메일 option 클릭시 email02에 값 입력되는 것 알아보기 -->
                            <select class="select margin-left10 email01" id="email3">
                    ...
                    <div class="d-flex">
                        ...
                        <input class="input work-school" type="text" name="belong_to" id="belong_to" autocomplete="off">
                    </div>
                    <div class="d-flex">
                        ...
                        <div class="phone d-flex">
                            ...
                            <span>&nbsp;-&nbsp;</span>
                            <input class="input phone2 w100" id="tel2" type="text" pattern="[0-9]*" value="" maxlength="4" autocomplete="off">
                            <span>&nbsp;-&nbsp;</span>
                            <input class="input phone3 w100" id="tel3" type="text" pattern="[0-9]*" value="" maxlength="4" autocomplete="off">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="phone mobile-phone d-flex">
                            <select class="select mobile-phone1" id="phone1" name="mobile-phone1">
                                <option value="선택" selected>선택</option>
                            ...
                            <span>&nbsp;-&nbsp;</span>
                            <input class="input mobile-phone2 w100" id="phone2" type="text" pattern="[0-9]*" value="" maxlength="4" autocomplete="off">
                            <span>&nbsp;-&nbsp;</span>
                            <input class="input mobile-phone3 w100" id="phone3" type="text" pattern="[0-9]*" value="" maxlength="4" autocomplete="off">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="adressWrap">
                            <div class="adress adress1 d-flex">
                                <input class="input w355" type="text" id="post_code" name="post_code" value="" autocomplete="off">
	                ...
	                <div class="button-wrap d-flex justify_end margin-top40">
	                    <button class="btn_normal btn_large btn_pp" type="button" onclick="location.href='/smtp/user/sub01-02'">이전</button>
	                    <input type="submit" class="margin-left10 btn_normal btn_large btn_pp_bg" value="가입신청">
	                </div>
                </form>
            </div>
