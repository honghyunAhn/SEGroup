    ...
    <div class="footer d-flex justify_between">
        ...
        <div class="footer_navWrap">
            <ul class="footerNav d-flex">
                <li class="gnb">
                    <a href="rainbow-cousre01.html" class="fc_point01">해외취업캠퍼스</a>
                    <ul class="lnb">
                ...
                <li class="gnb">
                    <a href="rainbow-cousre03.html" class="fc_point03">자격증 코스</a>
                    <ul class="lnb">
                ...
                <li class="gnb">
                    <a href="rainbow-cousre04.html" class="fc_point04">글로벌 잡매칭</a>
                    <ul class="lnb">
                        <li><a href="">2021 하반기 잡페어</a></li>
                    </ul>
                </li>
                <li class="gnb">
                    <a href="rainbow-community.html" class="fc_point05">커뮤니티</a>
                    <ul class="lnb">
                        <li><a href="">공지사항</a></li>
                        <li><a href="">FAQ</a></li>
                        <li><a href="">Q&A</a></li>
