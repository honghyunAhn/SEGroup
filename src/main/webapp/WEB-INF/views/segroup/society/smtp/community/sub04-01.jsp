...
<head>
    ...
    <script type="text/javascript">
	    function ilist(page){
	        location.href="/smtp/community/sub04-01.do?curPage="+page+"&searchOption=${map.searchOption}"+"&keyword=${map.keyword}";
	    }
	
	    function goBoardDetail(seq){
	    	location.href="/smtp/community/sub04-01-01.do?seq="+seq;
	    }
	    ...
	    function search(){
	    	  ...
	    	  location.href="/smtp/community/sub04-01.do?searchOption="+searchoption+"&keyword="+searchword;
	    }
    </script>
</head>
<body>
