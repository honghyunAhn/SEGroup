	...
	<div class="container subPage_container sub01 d-flex">
        <div class="resumeContent subPage_content">
            <div class="resumeSection">
            	...
            	<form action="/smtp/apply/insert" name="resume" id="resumeForm" method="post" enctype="multipart/form-data">
                            ...
                            <div class="resumeFormWrap">
                                    ...
                                    <div class="resumeForm_text form100 rsmForm_address d-flex justify_between">
                                        <div class="rsm_txt">
                                            ...
                                            <div class="rsmForm_addressDiv d-flex justify_between">
                                                <input type="text" class="rsm_input loadAddress" id="zipcode" name="stu_app_zipcode" placeholder="우편번호" style="cursor:default;" readonly>
                                                <input type="text" class="rsm_input loadAddress" id="address" name="stu_app_addr" placeholder="주소" style="cursor:default;" readonly>
                                                <input type="text" class="rsm_input " id="addressDetail" name="stu_app_addr_detail" placeholder="상세주소를 입력하세요.">
                                            </div>
                                        </div>
                                        <!-- 우편번호 검색 기능 넣기 -->
                                ...
                                <div class="resumeForm row d-flex">
                                    <div class="resumeForm_text form33">
                                        ...
                                        <input type="text" class="rsm_input" name="stu_app_phone" value="${detail.user_phone }" type="number" pattern="[0-9]*" maxlength="11" autocomplete="off">
                                    </div>
                                    <div class="resumeForm_text form33">
                                        <label for="" class="rsm_label">비상연락처</label>
                                        <input type="text" class="rsm_input" name="stu_app_em_phone" type="number" pattern="[0-9]*" value="" maxlength="11" autocomplete="off">
                                    </div>
                                    <div class="resumeForm_text form33">
                                        <div class="rsm_label">이메일<strong class="cRed">＊</strong></div>
                                        <input type="text" class="rsm_input" name="stu_app_email" value="${detail.user_email }">
                                    </div>
                                </div>
                                    ...
                                    <div class="resumeFormWrap">
                                        <div class="resumeForm row d-flex">
                                            ...
                                            <div class="resumeForm_text form25">
                                                ...
                                                <input type="text" class="rsm_input crr_phone" name="careerList[0].stu_app_crr_phone" value="" autocomplete="off">
                                    ...
                                    <div class="resumeFormWrap">
                                        <div class="resumeForm row d-flex">
                                            ...
                                            <div class="resumeForm_text form20">
                                                ...
                                                <input type="text" class="rsm_input kmove_st" id="stu_app_kmove_frm_0" name="kmoveList[0].stu_app_kmove_st" autocomplete="off">
                                            </div>
                                            <div class="resumeForm_text form20">
                                                <div class="rsm_label">종료일<strong class="cRed">＊</strong></div>
                                                <input type="text" class="rsm_input kmove_et" id="stu_app_kmove_end_0" name="kmoveList[0].stu_app_kmove_et" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!--                            <div class="resumeFormWrapper necessary"> -->
                                    ...
                                    <div class="resumeFormWrap">
                                        <div class="resumeForm row">
                                            <div class="resumeForm_text form100">
                                                <input type="text" class="rsm_input introduce_title introduce_input" name="introduceList[0].stu_app_introduce_title" placeholder="제목입력" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="resumeForm row">
                                            <textarea class="rsm_textarea introduce_detail introduce_input" name="introduceList[0].stu_app_introduce_detail" placeholder="내용입력" rows="8" cols="80"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="resumeWrap rsm_evidence" id="rsm_evidence" name="matchLink">
                        ...
                        <div class="button resumeBtn h2">지원하기</div>
                    </div>
                </form>
            </div>
        </div>
