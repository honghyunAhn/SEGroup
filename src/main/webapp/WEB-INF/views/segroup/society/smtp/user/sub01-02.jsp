    ...
    <div class="container_rainbow">
        ...
        <div class="content sub-content sub01_content" id="main">
            ...
            <ul class="processWrap d-flex">
                <li class="process active"><span class="margin-right10">01</span>약관확인</li>
                <li class="process"><span class="margin-right10">02</span>정보입력</li>
                <li class="process"><span class="margin-right10">03</span>가입완료</li>
            </ul>
            <div class="section section_sub01-02">
                <form action="/smtp/user/sub01-02-01" method="post" id="signUp-check" class="formStyle join">
                    <!-- 2) 회원가입 - 1단계) 약관 동의 -->
                    ...
                    <acrticle class="signUp-agree">
                        ...
                        <div class="checkWrap d-flex justify_center">
                            ...
                            <label for="agree02" class="label">위 서비스 이용방침에 동의합니다.(필수)</label>
                        </div>
                    </acrticle>
<!-- 					<div class="checkWrap d-flex justify_center all-check"> -->
<!-- 	                    <input type="checkbox" class="check input" name="agreeAll" id="agreeAll"> -->
<!-- 	                    <label for="agreeAll" class="label">위의 모든 약관 내용을 확인하였으며 이에 동의합니다.</label> -->
<!-- 	                </div> -->
                    <!-- 2) 회원가입 - 1단계) 휴대폰인증 -->
                    <acrticle class="certification">
                        <header class="section_header">
                            <strong class="h4">
                                레인보우에서는 깨끗하고 안전한 인터넷 서비스 이용을 위해 본인확인을 받고 있습니다.
                            </strong>
                            <h5 class="fz14">
                                입력하신 개인정보는 회원님의 동의 없이 제 3자에게 제공되지 않으며, 개인정보처리방치에 따라 보호되고 있습니다.
                                <br>입력하신 정보는 본인확인용으로 사용되며 회원가입이 완료되면 사용자 확인을 위해 회원정보 고유의 값으로 저장됩니다.<br>
                            </h5>
                        </header>
                        <div class="certificationWrap">
                            <div class="certif-boxWrap d-flex justify_center">
                                <div class="certif">
                                    <h3 class="h3 fc_pp">휴대폰인증</h3>
                                    <p class="fc_666 margin-top10">
                                        본인 명의의 휴대폰 번호로 인증합니다. 타인 명의의 휴대폰은 인증이 불가합니다.<br>본인인증으로 가입여부를 확인 후 신청이 가능합니다.
                                    </p>
                                    <button class="btn_normal btn_pp_bg btn_xlarge" id="validBtn" type="button">인증하기</button>
                                    <div>
