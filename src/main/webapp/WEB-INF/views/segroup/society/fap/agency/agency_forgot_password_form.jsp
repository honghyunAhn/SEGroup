...
<%@include file="agency_menu.jsp"%>
	...
	<div id="subvisual"><img src="<c:url value="/resources/segroup/society/fap/images/subtitlt_img5.png" />" />
		<div id="navigation"><img src="<c:url value="/resources/segroup/society/fap/images/icon_red.gif" />" /> Home > <spring:message code="fap.common.find_pw" /></div>
	</div>
	<!-----------------------/서브비주얼 영역-------------------------->
	...
	<div id="subcontents">
		<div id="idpwBox">
			<div id="innerBox" style="padding-left: 33%;">
				<form action="<c:url value='/fap/agency/agency_forgot_password_change' />" method="POST" onsubmit="return checkOnSubmit();">
					...
					<div class="logintxt5" style="text-align: left;">
						<button class="btn17 btn-primary" style="width:55%; border-color:#005A8C; background:#007ec4; border:1px solid #bbb; font-size:16px; color:#fff;">
