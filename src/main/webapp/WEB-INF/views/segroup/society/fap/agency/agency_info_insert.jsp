...
<div class="join-wrap">
	<div id="subcontents">
	<form action="/fap/agency/agency_info_insert" method="post" enctype="multipart/form-data" id="agency_info_insert">
		<div id="agency_insert">
			<div class="joinBox">
				<div class="jointt">
					<p class="jointxt1">
				...
				<div class="join-contents">
					<div class="joinBBS">
							...
							<div class="joinBBS-row">
								...
								<div class="joinrt"><input type="text" id="fap_comp_major_bussiness" name="fap_comp_major_bussiness" class="input" maxlength="100" placeholder="50<spring:message code="fap.placeholder.limit_characters" />"></div>
							</div>
							<div class="joinBBS-row">	
								<!-- 홈페이지 -->
							...
							<div class="joinBBS-row">
								...
								<div class="joinrt">
									<input type="file" id="fap_comp_log_file" name="fap_comp_log_file" class="input3">
								</div>
							</div>
