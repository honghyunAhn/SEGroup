		...
		myApp.controller('RequiredDocController', ['$scope','$compile','$http', function($scope,$compile,$http){
			...
			if(job_qna_list.length == 0){
				...
				for(var i in job_qna_list){
				 ...
				 context += '	<li class="wid2"><a href="/fap/agency/agency_job_qna?fap_job_qna_question_seq=' + job_qna_list[i].fap_job_qna_question_seq + '">' + job_qna_list[i].fap_job_qna_question_title + '</a></li>';
