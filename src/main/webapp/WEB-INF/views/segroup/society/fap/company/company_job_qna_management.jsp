		...
		myApp.controller('RequiredDocController', ['$scope','$compile','$http', function($scope,$compile,$http){
			...
			if(job_qna_list.length == 0){
				...
				for(var i in job_qna_list){
					...
					context += '	<li class="wid2"><a href="/fap/company/company_job_qna?fap_job_qna_question_seq=' + job_qna_list[i].fap_job_qna_question_seq + '">' + job_qna_list[i].fap_job_qna_question_title + '</a></li>';
		...
		<div id="qnaBBS">
			<div>
				<ul class="qnatitle">
					...
					<li class="wid2"><spring:message code="fap.jobad.qna.question_title" /></li>
