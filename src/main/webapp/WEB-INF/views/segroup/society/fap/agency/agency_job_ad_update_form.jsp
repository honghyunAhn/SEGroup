...
<script type="text/javascript">
	...
	myApp.controller('JobAdController',['$scope','$compile', function($scope, $compile) {
		...
		for(var i in jobRecruitPcs){
			...
			context += '</div>';
			context += '<div class="job-ad-rt">';
			context += '<textarea rows="4" cols="20" name="jobRecruitPcsList['+count+'].fap_job_recruit_pcs_dtl" maxlength="500" ng-model="::jobRecruitPcs['+i+'].fap_job_recruit_pcs_dtl"></textarea>';
			context += '</div>';
			context += '</div>';
			context += '</div>';			
...
<body ng-app="myapp" ng-controller="JobAdController" id="company_job_ad_body">
	...
	<div class="job-ad-wrap">
		...
		<form action="agency_job_ad_update" method="post" enctype="multipart/form-data" id="insert_form">
