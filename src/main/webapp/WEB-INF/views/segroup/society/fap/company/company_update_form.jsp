...
<div class="join-wrap">
	<div id="subcontents">
		<form action="/fap/company/company_update_form" method="post" enctype="multipart/form-data" id="company_update_form">
				...
				<div class="joinBox">
						...
						<div class="join-contents">
							<div class="joinBBS">
									...
									<div class="joinBBS-row">
										...
										<div class="joinrt"><input type="text" id="fap_comp_business_num" name="fap_comp_business_num" ng-model="company_info.fap_comp_business_num" maxlength="25" placeholder="<spring:message code="fap.placeholder.business_num" />"></div>
									</div>
									<div class="joinBBS-row">
										<!-- 대표자명 -->
									...
									<div class="joinBBS-row">
										...
										<div class="joinrt"><input type="text" id="fap_comp_major_bussiness" name="fap_comp_major_bussiness" ng-model="company_info.fap_comp_major_bussiness" maxlength="100" placeholder="100<spring:message code="fap.placeholder.limit_characters" />"></div>
									</div>
									<div class="joinBBS-row">	
										<!-- 홈페이지 -->
									...
									<div class="joinBBS-row">
										...
										<div class="joinrt"><input type="text" id="fap_comp_postcode" name="fap_comp_postcode" ng-model="company_info.fap_comp_postcode" maxlength="20" maxlength="10" placeholder="<spring:message code="fap.placholder.postcode" />"></div>
									</div>
									<div class="joinBBS-row">
										<!-- 주소 -->
					...
					<div class="joinBox">
						<div class="join-policy">
							<div id="joinBtn">
								<button type="button" class="join-btn icon submitBtn" onclick="form_check();"><spring:message code="fap.common.update.btn" /></button>
							</div>
						</div>
					</div>
				</form>
