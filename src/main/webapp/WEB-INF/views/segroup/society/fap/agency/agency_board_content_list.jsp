	...
	<script type="text/javascript">
		    ...
		    myApp.controller('BoardListController', ['$scope','$compile', '$http',function($scope,$compile,$http){
				...
				$scope.titleClick = function(board_content_seq,  board_gb, board_tp){
					...
					location.href="/fap/agency/agency_board_contents_datail?board_content_seq=" + board_content_seq   + "&board_gb=" + board_gb + "&board_tp=" + board_tp+"&board_detail_gb="+ board_detail_gb+"&board=same_board";
				}			
				...
				$scope.ilist = function(page){			
					...
					$http({
						method: 'POST',
						url: '/fap/agency/agency_board_content_list_search',
						responseType : 'text',
						params : {
						      pageBegin : pageBegin
							, curPage : curPage                    
