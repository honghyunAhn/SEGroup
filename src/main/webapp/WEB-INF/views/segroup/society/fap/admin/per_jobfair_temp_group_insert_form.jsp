...
myApp.controller('AdminController', ['$scope','$compile','$http', function($scope,$compile,$http){
	...
	$http({
		...
		$.each(response.data,function(index, item){
			...
			context +='금액 : <input type="text" class="currency" name="perJobfairDivideList['+index+'].fap_per_jobfair_divide_temp_cost" ng-model="divide_cost" blur-currency>';
...
그룹 명 : <input type="text" name="fap_per_jobfair_temp_group_nm"> <br>
세부 잡페어당 금액 <br>
<div id="divideDiv">
