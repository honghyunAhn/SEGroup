	...
	<a href="/fap/admin/tokyofair_schedule_management">목록으로 가기</a>
		...
		<table class="search_box">
			...
			<tr>
				<th>잡페어 일정</th>
				<td>
					시작<input type="text" id="jobfair_st" name="fap_jobfair_set_st"> ~ 종료<input type="text" id="jobfair_et" name="fap_jobfair_set_et">
				</td>
			</tr>
			<tr>
				<th>기업 등록 일정</th>
				<td>
					시작<input type="text" id="fap_jobfair_set_comp_sd" name="fap_jobfair_set_comp_sd"><input type="text" id="fap_jobfair_set_comp_st" name="fap_jobfair_set_comp_st"> ~ 종료<input type="text" id="fap_jobfair_set_comp_ed" name="fap_jobfair_set_comp_ed"><input type="text" id="fap_jobfair_set_comp_et" name="fap_jobfair_set_comp_et">
				</td>
			</tr>
			<tr>
				<th>면접장 개수</th>
			...
			<tr>
				<th>면접장 사용 시간</th>
				<td>
					시작<input type="text" id="jobfair_room_st" name="fap_jobfair_set_room_st"> ~ 종료<input type="text" id="jobfair_room_et" name="fap_jobfair_set_room_et"> 
				</td>
			</tr>
			<tr>
