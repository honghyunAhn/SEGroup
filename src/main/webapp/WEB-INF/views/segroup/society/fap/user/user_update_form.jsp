...
var first_email = "";
	...
	myApp.controller('BBSController',['$scope','$compile', '$http', function($scope, $compile) {
		...
		var com_user = JSON.parse('${com_user}');
		$scope.com_user = JSON.parse('${com_user}');
		
		var user_info = JSON.parse('${user_info}');
		$scope.user_info = JSON.parse('${user_info}');
		
		var user_school = JSON.parse('${user_school}');
		$scope.user_school = JSON.parse('${user_school}');
		...
		// [start] 성별 체크 시작
		if(com_user.user_sex != ''){
			if(com_user.user_sex == 'A0000'){
				$('#sex_m').parent().addClass("ck");
			}
			if(com_user.user_sex == 'A0001'){
				$('#sex_f').parent().addClass("ck");
			}
		}
		// [end] 성별체크 끝
		...
		for(var i in kmoveList) {
			...
			if($scope.user_info.fap_personal_user_edu_ct_nm == edu_code){
				content += '<span>' + kmoveList[i].code_nm + '</span>';
			}
		}
		content += '	</button>';
		content += '	<input type="hidden" id="fap_personal_user_edu_ct_nm" name="fap_personal_user_edu_ct_nm" value="{{user_info.fap_personal_user_edu_ct_nm}}">';
		content += '</div>';
		...
		content += '	<button type="button" class="BBS-select-btn"><code value="' + user_info.fap_personal_user_edu_level + '"></code></button>';
		content += '	<input type="hidden" id="fap_personal_user_edu_level" name="fap_personal_user_edu_level" value="{{user_info.fap_personal_user_edu_level}}">';
		content += '</div>';
		content += '<div class="BBS-select-option">';
		content += '	<ul class="option-list">';
		content += '		<li class="option-type">';
		...
		// [start] 학력 세부 불러오기 시작
		// 고등학교 졸업
		if(user_info.fap_personal_user_edu_level == 'B3300'){
			
			content += '<div class="joinBBS-row">';
			content += '	<div class="joinlt">고등학교 명</div>';
			content += '	<div class="joinrt">';
			content += '		<input type="text" id="fap_personal_hs_nm" name="fap_personal_hs_nm" value="' + user_school.fap_personal_hs_nm + '">';
			content += '	</div>';
			content += '</div>';
			...
			content += '			</label>';
			content += '			<input type="radio" id="field_mk" name="fap_personal_hs_field" id="fap_personal_hs_field" value="B3400" ng-model="::user_school.fap_personal_hs_field" />';
			content += '		</span>';
			content += '		<span class="bbs-radio hs-field">';
			content += '			<label class="bbs-radio-label">';
			content += '				<code value="B3401"></code>';
			content += '			</label>';
			content += '			<input type="radio" id="field_lk" name="fap_personal_hs_field" id="fap_personal_hs_field" value="B3401" ng-model="::user_school.fap_personal_hs_field" />';
			content += '		</span>';
			content += '		<span class="bbs-radio hs-field">';
			content += '			<label class="bbs-radio-label">';
			content += '				<code value="B3402"></code>';
			content += '			</label>';
			content += '			<input type="radio" id="field_sh" name="fap_personal_hs_field" id="fap_personal_hs_field" value="B3402" ng-model="::user_school.fap_personal_hs_field" />';
			content += '		</span>';
			content += '	</div>';
			content += '</div>';
			content += '';
		...
		if(user_info.fap_personal_user_edu_level == 'B3301'
			...
			content += '	<div class="joinrt">';
			content += '		<input type="text" id="fap_personal_univ_nm" name="fap_personal_univ_nm" value="' + user_school.fap_personal_univ_nm + '">';
			content += '	</div>';
			content += '</div>';
			...
			content += '	<div class="joinrt">';
			content += '		<span class="bbs-radio univ_abroad">';
			content += '			<label class="bbs-radio-label">';
			content += '				<code value="B3500"></code>';
			content += '			</label>';
			content += '			<input type="radio" id="abroad_do" name="fap_personal_univ_abroad_ck" id="fap_personal_univ_abroad_ck" value="B3500" ng-model="::user_school.fap_personal_univ_abroad_ck" />';
			content += '		</span>';
			content += '		<span class="bbs-radio univ_abroad">';
			content += '			<label class="bbs-radio-label">';
			content += '				<code value="B3501"></code>';
			content += '			</label>';
			content += '			<input type="radio" id="abroad_ov" name="fap_personal_univ_abroad_ck" id="fap_personal_univ_abroad_ck" value="B3501" ng-model="::user_school.fap_personal_univ_abroad_ck" />';
			content += '		</span>';			
			content += '	</div>';		
			content += '</div>';
			...
			content += '			</label>';
			content += '			<input type="radio" id="coll_cs" name="fap_personal_univ_coll" id="fap_personal_univ_coll" value="B2800" ng-model="::user_school.fap_personal_univ_coll" />';
			content += '		</span>';
			content += '		<span class="bbs-radio univ-coll">';
			content += '			<label class="bbs-radio-label">';
			content += '				<code value="B2801"></code>';
			content += '			</label>';
			content += '			<input type="radio" id="coll_cs_e" name="fap_personal_univ_coll" id="fap_personal_univ_coll" value="B2801" ng-model="::user_school.fap_personal_univ_coll" />';
			content += '		</span>';
			content += '		<span class="bbs-radio univ-coll">';
			content += '			<label class="bbs-radio-label">';
			content += '				<code value="B2802"></code>';
			content += '			</label>';
			content += '			<input type="radio" id="coll_ja" name="fap_personal_univ_coll" id="fap_personal_univ_coll" value="B2802" ng-model="::user_school.fap_personal_univ_coll" />';
			content += '		</span>';
			content += '		<span class="bbs-radio univ-coll">';
			content += '			<label class="bbs-radio-label">';
			content += '				<code value="B2803"></code>';
			content += '			</label>';
			content += '			<input type="radio" id="coll_la" name="fap_personal_univ_coll" id="fap_personal_univ_coll" value="B2803" ng-model="::user_school.fap_personal_univ_coll" />';
			content += '		</span>';
			content += '		<span class="bbs-radio univ-coll">';
			content += '			<label class="bbs-radio-label">';
			content += '				<code value="B2804"></code>';
			content += '			</label>';
			content += '			<input type="radio" id="coll_ga" name="fap_personal_univ_coll" id="fap_personal_univ_coll" value="B2804" ng-model="::user_school.fap_personal_univ_coll" />';
			content += '		</span>';
			content += '		<span class="bbs-radio univ-coll">';
			content += '			<label class="bbs-radio-label">';
			content += '				<code value="B2805"></code>';
			content += '			</label>';
			content += '			<input type="radio" id="coll_ns" name="fap_personal_univ_coll" id="fap_personal_univ_coll" value="B2805" ng-model="::user_school.fap_personal_univ_coll" />';
			content += '		</span>';
			content += '		<span class="bbs-radio univ-coll">';
			content += '			<label class="bbs-radio-label">';
			content += '				<code value="B2806"></code>';
			content += '			</label>';
			content += '			<input type="radio" id="coll_eng" name="fap_personal_univ_coll" id="fap_personal_univ_coll" value="B2806" ng-model="::user_school.fap_personal_univ_coll" />';
			content += '		</span>';
			content += '		<span class="bbs-radio univ-coll">';
			content += '			<label class="bbs-radio-label">';
			content += '				<code value="B2807"></code>';
			content += '			</label>';
			content += '			<input type="radio" id="coll_etc" name="fap_personal_univ_coll" id="fap_personal_univ_coll" value="B2807" ng-model="::user_school.fap_personal_univ_coll" />';
			content += '		</span>';
			content += '		</span>';
			content += '	</div>';
			content += '</div>';
			...
			content += '	<div class="joinrt">';
			content += '		<input type="text" id="fap_personal_univ_major" name="fap_personal_univ_major" value="' + user_school.fap_personal_univ_major + '">';
			content += '	</div>';
			content += '</div>';
		...
		// 대학원 재학, 졸업
		if(user_info.fap_personal_user_edu_level == 'B3303'
			...
			content += '	<div class="joinrt">';
			content += '		<input type="text" id="fap_personal_grad_nm" name="fap_personal_grad_nm" value="' + user_school.fap_personal_grad_nm + '">';
			content += '	</div>';
			content += '</div>';
			...
			content += '			</label>';
			content += '			<input type="radio" id="grad_ms" name="fap_personal_grad_ck" id="fap_personal_grad_ck" value="B3600" ng-model="::user_school.fap_personal_grad_ck" />';
			content += '		</span>';
			content += '		<span class="bbs-radio grad-ck">';
			content += '			<label class="bbs-radio-label">';
			content += '				<code value="B3601"></code>';
			content += '			</label>';
			content += '			<input type="radio" id="grad_doc" name="fap_personal_grad_ck" id="fap_personal_grad_ck" value="B3601" ng-model="::user_school.fap_personal_grad_ck" />';
			content += '		</span>';			
			content += '	</div>';		
			content += '</div>';
			...
			content += '	<div class="joinrt">';
			content += '		<input type="text" id="fap_personal_grad_major" name="fap_personal_grad_major" value="' + user_school.fap_personal_grad_major + '">';
			content += '	</div>';
			content += '</div>';
		...
		// [start] 고등학교 계열 체크 시작
		if(user_school.fap_personal_hs_field != ''){
			if(user_school.fap_personal_hs_field == 'B3400'){
				$('#field_mk').parent().addClass("ck");
			}
			if(user_school.fap_personal_hs_field == 'B3401'){
				$('#field_lk').parent().addClass("ck");
			}
			if(user_school.fap_personal_hs_field == 'B3402'){
				$('#field_sh').parent().addClass("ck");
			}
		}
		// [end] 고등학교 계열 체크 끝
		
		// [start] 국내/외 구분 체크 시작
		if(user_school.fap_personal_univ_abroad_ck != ''){
			if(user_school.fap_personal_univ_abroad_ck == 'B3500'){
				$('#abroad_do').parent().addClass("ck");
			}
			if(user_school.fap_personal_univ_abroad_ck == 'B3501'){
				$('#abroad_ov').parent().addClass("ck");
			}
		}
		// [end] 국내/외 구분 체크 끝
		
		// [start] 학부 체크 시작
		if(user_school.fap_personal_univ_coll != ''){
			if(user_school.fap_personal_univ_coll == 'B2800'){
				$('#coll_cs').parent().addClass("ck");
			}
			if(user_school.fap_personal_univ_coll == 'B2801'){
				$('#coll_cs_e').parent().addClass("ck");
			}
			if(user_school.fap_personal_univ_coll == 'B2802'){
				$('#coll_ja').parent().addClass("ck");
			}
			if(user_school.fap_personal_univ_coll == 'B2803'){
				$('#coll_la').parent().addClass("ck");
			}
			if(user_school.fap_personal_univ_coll == 'B2804'){
				$('#coll_ga').parent().addClass("ck");
			}
			if(user_school.fap_personal_univ_coll == 'B2805'){
				$('#coll_ns').parent().addClass("ck");
			}
			if(user_school.fap_personal_univ_coll == 'B2806'){
				$('#coll_eng').parent().addClass("ck");
			}
			if(user_school.fap_personal_univ_coll == 'B2807'){
				$('#coll_etc').parent().addClass("ck");
			}
		}
		// [end] 학부 체크 끝
		
		// [start] 석/박사 구분 체크 시작
		if(user_school.fap_personal_grad_ck != ''){
			if(user_school.fap_personal_grad_ck == 'B3600'){
				$('#grad_ms').parent().addClass("ck");
			}
			if(user_school.fap_personal_grad_ck == 'B3601'){
				$('#grad_doc').parent().addClass("ck");
			}
		}
		// [end] 석/박사 구분 체크 종료
	...
	function user_delete() {
		...
		var windowObj = window.open("/fap/user/user_info_delete_form", "회원 탈퇴 폼", settings);
	}
...
<body ng-app="myapp" ng-controller="BBSController">
	<sec:authorize access="hasAnyRole('ROLE_A0100', 'ROLE_A0101', 'ROLE_A0106')">
	...
	<input type="hidden" name="user_flag" value="{{com_user.user_flag}}">
	<input type="hidden" name="user_state" value="{{com_user.user_state}}">
	<input type="hidden" id="user_origin_email" name="user_origin_email" size="30" value="{{com_user.user_email}}">
			...
			<div class="joinBox">
				...
				<div class="join-contents">
					...
					<div class="joinBBS">
							<div class="joinBBS-row">
								...
								<div class="joinrt">
									<input type="text" id="user_id" name="user_id" ng-model="com_user.user_id" readonly="readonly">
								</div>
							</div>
							<div class="joinBBS-row">
							...
							<div class="joinBBS-row">
								...
								<div class="joinrt"><input type="text" id="user_nm" name="user_nm" ng-model="com_user.user_nm" placeholder="<spring:message code="fap.placholder.name" />"></div>
							</div>
							<div class="joinBBS-row">
								<div class="joinlt">E-mail</div>
								<div class="joinrt">
									<input type="text" id="user_email" name="user_email" size="30" ng-model="com_user.user_email">
							...
							<div class="joinBBS-row">
								...
								<div class="joinrt"><input type="text" id="user_birth" name=user_birth ng-model="com_user.user_birth" readonly="readonly"></div>
							</div>
							...
							<div class="joinBBS-row radio-row">
								...
								<div class="joinrt">
									<span class="bbs-radio sex-type">
										...
										<input type="radio" name="user_sex" id="sex_m" value="A0000" ng-model="::com_user.user_sex" />
									</span>
									<span class="bbs-radio sex-type">
										<label class="bbs-radio-label">
											<code value="A0001"></code>
										</label>
										<input type="radio" name="user_sex" id="sex_f" value="A0001" ng-model="::com_user.user_sex" />
									</span>
								</div>
							</div>
							...
							<div class="joinBBS-row">
								...
								<div class="joinrt">
									<input type="text" id="user_phone" name="user_phone" ng-model="com_user.user_phone" placeholder="<spring:message code="fap.placholder.name" />">
							...
							<div class="joinBBS-row">
								...
								<div class="joinrt">
									<input type="text" id="job_objective" name="fap_personal_user_job_objective" ng-model="user_info.fap_personal_user_job_objective"  placeholder="(예. ICT, 기계전기전자분야, 일반사무, 통역, 관광/여객, 마케팅 등)">
								</div>
							</div>
							<div class="joinBBS-row">
						...
						<div class="joinBBS-row disnone course">
							...
							<div class="joinrt">
								<input type="text" id="edu_course_nm" name="fap_personal_user_edu_course_nm" ng-model="user_info.fap_personal_user_edu_course_nm" placeholder="(예. 기관명-과정명)">
							</div>
						</div>
							<div class="joinBBS-row">
				...
				<div class="joinBox">
					<div class="join-policy">
						<div id="joinBtn">
							<button class="join-btn icon submitBtn" onclick="submit_button();"><spring:message code="fap.common.user_update"/></button>
							<!-- 회원 탈퇴 -->
							<a href="javascript:user_delete()">
