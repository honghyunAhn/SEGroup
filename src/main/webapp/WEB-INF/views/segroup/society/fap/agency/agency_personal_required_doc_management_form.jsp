	...
	<script type="text/javascript">
		...
		myApp.controller('RequiredDocController', ['$scope','$compile','$http', function($scope,$compile,$http){	
			...
			if("${nominee_info.fap_nominee_seq}" != null && "${nominee_info.fap_nominee_seq}" != ''){
				...
				$http({
					method: 'POST',
					url: "/fap/agency/agency_personal_required_doc_search_list",
					params : {
					...
					$scope.personal_user_required_doc_draw(response);
						...
						$http({
							method: 'POST',
							url: "/fap/agency/agency_nominee_info_search",
							params : {
			...
			$scope.update = function(fap_personal_required_doc_seq){
				...
				$http({
					method: 'POST',
					url: "/fap/agency/agency_personal_required_doc_search",
					params : {
			...
			$scope.update_required_doc_draw = function(result){
				...
				context += '</button>';
				context += '</div>';
				context += '<form action="/fap/agency/agency_personal_required_doc_update" method="post" onsubmit="return update_form_Check();" enctype="multipart/form-data">';
...
<!-----------------------서브컨텐츠 영역-------------------------->
	<div id="subcontents">
	      <div>      		
	      	<h1><spring:message code="fap.comp.personal_required_doc_management" /></h1>
	      </div>
	 	<div>
	...
	<div class="modal fade" id="registerModal" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="/fap/agency/agency_personal_required_doc_insert" method="post" onsubmit="return form_Check();" enctype="multipart/form-data">
