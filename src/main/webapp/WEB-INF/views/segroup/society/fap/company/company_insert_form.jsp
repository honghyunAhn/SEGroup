	...
	function checkEmailIsDuplicated() {
 	...
 	function checkOnSubmit() {
		...
		if($('#company_nonexistent').prop("checked")){
			...
			var fap_comp_scit_num = $('#fap_comp_scit_num');
			var fap_comp_korean_num = $('#fap_comp_korean_num');
			var fap_comp_foreigner_num = $('#fap_comp_foreigner_num');
			//사진유무체크
		...
		if (fileSizeCheck(size)) {
			...
			$.ajax({
				...
				success : function(data) {
					$("#imgDiv").empty();
					$("#imgDiv").html('<img style="width:30%; height:30%; alt="" src="/edu/temporarilyPath/'+data.savedfile+'">');
				},
				error : function(e) {
					//console.log(e);
				}
...
<div class="join-wrap">
	<div id="subcontents">
		<!-- <h1>회원가입</h1><h6>회원가입 하시고 더 많은 혜택을 받으세요!</h6> -->
	<form action="/fap/company/company_insert_form" method="post" enctype="multipart/form-data" id="company_insert_form">
		<div class="joinBox">
			<div class="jointt">
				<p class="jointxt1">
			...
			<div class="join-contents">
				...
				<div class="joinBBS">
						<div class="joinBBS-row">
							<div class="joinlt point"><spring:message code="fap.common.user_id" /><span class="red-point"></span></div>
							<div class="joinrt">
						...
						<div class="joinBBS-row">
							<div class="joinlt point"><spring:message code="fap.common.password" /><span class="red-point"></span></div>
							<div class="joinrt point"><input type="password" id="user_pw" name="user_pw" class="input" maxlength="50" placeholder="<spring:message code="fap.placholder.pw" />"><span class="red-point"></span></div>
						</div>
						<div class="joinBBS-row">
							<div class="joinlt point"><spring:message code="fap.common.password_ck" /><span class="red-point"></span></div>
				...
				<div class="join-contents">
					<div class="joinBBS">
							...
							<div class="joinBBS-row">
								...
								<div class="joinrt">
									<input type="text" class="input currency" id="fap_comp_stock" name="fap_comp_stock" ng-model="fap_comp_stock_inst" maxlength="22" blur-currency>
							...
							<div class="joinBBS-row">
								...
								<div class="joinrt">
									<input type="text" class="input currency" id="fap_comp_3years_avg_sales" name="fap_comp_3years_avg_sales" ng-model="fap_comp_3years_avg_sales_inst" maxlength="22" blur-currency>
									<span class="hiddenTx">円</span>
								</div>
							</div>
							<div class="joinBBS-row">	
