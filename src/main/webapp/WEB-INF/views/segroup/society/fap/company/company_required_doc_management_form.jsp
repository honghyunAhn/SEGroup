	...
	<script type="text/javascript">
		...
		myApp.controller('RequiredDocController', ['$scope','$compile','$http', function($scope,$compile,$http){
				...
				if('${fap_ad_seq}' != null && '${fap_ad_seq}' != 0){
					...
					$http({
						method: 'POST',
						url: "/fap/company/company_job_ad_list_search",
						params : {
					...
					$http({
						method: 'POST',
						url: "/fap/company/company_common_required_doc_search_list",
						params : {
							fap_job_ad_seq : fap_job_ad_seq
							, fap_comp_id : fap_comp_id
						},
						...
						$(".modal-body #fap_job_ad_seq").val(fap_job_ad_seq);
							...
							$http({
								method: 'POST',
								url: "/fap/company/company_nominee_info_search_list",
								params : {
									fap_job_ad_seq : fap_job_ad_seq
									, fap_comp_id : fap_comp_id
								}
					...
					$scope.common_required_doc_draw_3 = function(response){
		                ...
		                context += '<li class="wid5" ><a href="/fap/company/company_common_required_doc_delete?fap_common_required_doc_seq={{result_3.fap_common_required_doc_seq}}&fap_common_required_doc_saved={{result_3.fap_common_required_doc_saved}}&fap_comp_id={{result_3.fap_comp_id}}&fap_job_ad_seq={{result_3.fap_job_ad_seq}}&fap_jobfair_seq={{result_3.fap_jobfair_seq}}&fap_jobfair_divide_seq={{result_3.fap_jobfair_divide_seq}}"><button value="{{result_3.fap_common_required_doc_seq}}" class="deleteBtn"><spring:message code="fap.comp.required_doc_delete" /></button></a></li>';
		            	context += '</ul>';			
					...
					$scope.nominee_draw_3 = function(response){
						...
						context += '<li class="wid6" ng-if="nominee_3.fap_resume_gender == \'A0001\' "><code value="A0001"></code></li>';
				...
				if('${fap_job_ad_seq}' != 0){					
					...
					$scope.common_required_doc_draw_1 = function(response){
		                ...
		                context += '<li class="wid5" ><a href="/fap/company/company_common_required_doc_delete?fap_common_required_doc_seq={{result_1.fap_common_required_doc_seq}}&fap_common_required_doc_saved={{result_1.fap_common_required_doc_saved}}&fap_comp_id={{result_1.fap_comp_id}}&fap_job_ad_seq={{result_1.fap_job_ad_seq}}&fap_jobfair_seq={{result_1.fap_jobfair_seq}}&fap_jobfair_divide_seq={{result_1.fap_jobfair_divide_seq}}"><button value="{{result_1.fap_common_required_doc_seq}}" class="deleteBtn"><spring:message code="fap.comp.required_doc_delete" /></button></a></li>';
		            	context += '</ul>';			
					...
					$scope.nominee_draw_1 = function(response){
						...
						context += '<li class="wid6" ng-if="nominee_1.fap_resume_gender == \'A0001\' "><code value="A0001"></code></li>';
				...
				$scope.job_ad_change = function(){
					...
					$scope.common_required_doc_draw_2 = function(response){
		                ...
		                context += '<li class="wid5" ><a href="/fap/company/company_common_required_doc_delete?fap_common_required_doc_seq={{result_2.fap_common_required_doc_seq}}&fap_common_required_doc_saved={{result_2.fap_common_required_doc_saved}}&fap_comp_id={{result_2.fap_comp_id}}&fap_job_ad_seq={{result_2.fap_job_ad_seq}}&fap_jobfair_seq={{result_2.fap_jobfair_seq}}&fap_jobfair_divide_seq={{result_2.fap_jobfair_divide_seq}}"><button value="{{result_2.fap_common_required_doc_seq}}" class="deleteBtn"><spring:message code="fap.comp.required_doc_delete" /></button></a></li>';
		            	context += '</ul>';			
					...
					$scope.nominee_draw_2 = function(response){
						...
						context += '<li class="wid6" ng-if="nominee_2.fap_resume_gender == \'A0001\' "><code value="A0001"></code></li>';
			...
			$scope.update = function(fap_common_required_doc_seq){
				...
				$http({
					method: 'POST',
					url: "/fap/company/company_common_required_doc_search",
					params : {
			...
			$scope.update_required_doc_draw = function(result){
				...
				context += '</button>';
				context += '</div>';
				context += '<form action="/fap/company/company_common_required_doc_update" method="post" onsubmit="return update_form_Check();" enctype="multipart/form-data">';
				...
				context += '</div>';
				context += '<div class="form-row">';
				context += '<textarea name="fap_common_required_doc_detail" id="fap_common_required_doc_update_detail" value="'+result.fap_common_required_doc_detail+'" class="form-control" maxlength="500" style="text-align: inherit; width:670px; height: 100px;" ></textarea>';
				context += '</div>';
				context += '</div>';
				context += '<div class="form-group">';
...
<body ng-app="myapp" ng-controller="RequiredDocController">
	...
	<div id="subcontents">
       <div>      		
      		<h1>${company_info.fap_comp_ja_nm} <spring:message code="fap.comp.common_required_doc_management" /></h1>
       </div>
	 	<div>
	 	<div id="top">
			...
			<select onchange="angular.element(this).scope().search_change()" id="select_jobfair_divide" disabled="disabled" style="width: 200px; height: 26px;">
	...
	<div class="modal fade" id="registerModal" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="/fap/company/company_common_required_doc_insert" method="post" onsubmit="return form_Check();" enctype="multipart/form-data">
