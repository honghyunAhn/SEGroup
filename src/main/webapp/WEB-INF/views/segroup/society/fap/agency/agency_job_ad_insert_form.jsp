...
<script type="text/javascript">
	...
	function return_list() {
		...
		location.href='/fap/agency/agency_job_ad_management?fap_jobfair_seq='+fap_jobfair_seq+'&fap_jobfair_divide_seq='+fap_jobfair_divide_seq;
	}
	...
	function ad_load(fap_job_ad_seq) {
		if(confirm('<spring:message code="fap.jobad.call_pre_jobad" />')){
			...
			var url = '';
			url += '/fap/agency/agency_job_ad_insert_form_load?fap_jobfair_seq=';
			url += fap_jobfair_seq;
...
<body ng-app="myapp" ng-controller="JobAdController" id="company_job_ad_body">
	...
	<div class="job-ad-wrap">
		...
		<form action="agency_job_ad_insert" method="post" enctype="multipart/form-data" id="insert_form">
		<div class="job-ad-box">
						
			<input type="hidden" name="fap_job_ad_ins_id" value="${chosen_fap_comp_id}">
			<input type="hidden" name="fap_job_ad_udt_id" value="${chosen_fap_comp_id}">
			<input type="hidden" name="fap_job_dorm_ins_id" value="${chosen_fap_comp_id}">
			<input type="hidden" name="fap_job_dorm_udt_id" value="${chosen_fap_comp_id}">
			<input type="hidden" name="fap_job_jit_employee_ins_id" value="${chosen_fap_comp_id}">
			<input type="hidden" name="fap_job_jit_employee_udt_id" value="${chosen_fap_comp_id}">
			<input type="hidden" name="fap_job_ja_level_ins_id" value="${chosen_fap_comp_id}">
			<input type="hidden" name="fap_job_ja_level_udt_id" value="${chosen_fap_comp_id}">
			<input type="hidden" name="fap_job_trial_ins_id" value="${chosen_fap_comp_id}">
			<input type="hidden" name="fap_job_trial_udt_id" value="${chosen_fap_comp_id}">
			...
			<input type="hidden" name="fap_comp_id" value="${chosen_fap_comp_id}">
			...
			<div class="job-ad-contents scrollspy">
		    	...
		    	<div class="job-ad-row">
					...
					<div class="job-ad-rt">
						<input class="input3 currency" type="text" id="fap_job_ad_employee_num" name="fap_job_ad_employee_num" ng-model="comp_info.fap_comp_employee_num" blur-currency maxlength="9">
		...
		<div id="hire_info" class="job-ad-box scrollspy">
			...
			<div class="job-ad-contents">
				...
				<div class="job-ad-row m50">
					...
					<div class="job-ad-rt">
						<input class="input2 currency" ng-model="fap_job_ad_recruit_num" type="text" id="fap_job_ad_recruit_num" name="fap_job_ad_recruit_num" blur-currency maxlength="9">
						<span class="hiddenTx">名</span>
					</div>
		    	</div>	
