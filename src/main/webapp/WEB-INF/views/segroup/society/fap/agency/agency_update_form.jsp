...
<script type="text/javascript">
	...
	myApp.controller('AgencyController',['$scope','$compile', '$http', function($scope, $compile, $http) {
		...
		$('#imgDiv').append('<img alt="" style="width:30%; height:30%;" src="/fap/company/user_logo_image/' + company_info_json.fap_comp_id + '/' + company_info_json.fap_comp_log_saved + '">');
...
<div class="join-wrap">
	<div id="subcontents">
		<form action="/fap/agency/agency_update_form" method="post" enctype="multipart/form-data" id="agency_update_form">
		...
		<div id="company_insert">
					...
					<div class="join-contents">
						<div class="joinBBS">
								...
								<div class="joinBBS-row">
									...
									<div class="joinrt"><input type="text" id="fap_comp_postcode" name="fap_comp_postcode" ng-model="company_info.fap_comp_postcode" maxlength="20" placeholder="<spring:message code="fap.placholder.postcode" />"></div>
								</div>
								<div class="joinBBS-row">
									<!-- 주소 -->
				...
				<div class="joinBox">
					<div class="join-policy">
						<div id="joinBtn">
							<button type="button" class="join-btn icon" onclick="form_check();"><spring:message code="fap.common.update.btn" /></button>
						</div>
					</div>
				</div>
		</form>
