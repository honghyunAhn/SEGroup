...
<script type="text/javascript">
	...
	function terms_agree() {
		...
		$.ajax({
			...
			, url : '/fap/company/company_terms_update'
			, type : 'post'
			, data : {
				user_id : user_id
			}
			, success : function(data) {
				if(data == 1){
					...
					window.location.href = '/fap/company/company_security_invalidate';
				}
...
<!-- <button onclick="terms_agree()">동의</button>	<button onclick="location.href='/fap/company/company_security_invalidate'">미동의</button> -->
