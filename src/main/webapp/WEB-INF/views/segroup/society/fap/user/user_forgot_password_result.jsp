...
<body>
	<section class="login_wrap">
		...
		<c:if test="${not canChange}">
				...
				<li>
					<a href="/fap/user/user_forgot_password_form">비밀번호 찾기</a>
				</li>
				</ul>
			</div>
		</c:if>
	...
	<section class="login_wrap">
		...
		<c:if test="${canChange}">
				...
				<div style="width: 100%; height: 100px; border: 1px 1px 1px 1px;">
					<ul class="login_menu1">
						<li>
							<a href="/fap/user/user_login"><h4><spring:message code="fap.common.move_login" /></h4></a>
						</li>
					</ul>
				</div>	
		</c:if>
		...
		<c:if test="${not canChange}">
				...
				<div style="width: 100%; height: 100px; border: 1px 1px 1px 1px;">
					<ul class="login_menu2">
						...
						<li>
							<a href="/fap/user/user_forgot_password_form"><h4><spring:message code="fap.common.find_pw" /></h4></a>
						</li>
					</ul>
				</div>
		</c:if>
