				...
				<div class="gtco-container">
					...
					<table class="board_view">
						...
						<tbody>
							...
							<tr>
								<th scope="row">기수명</th>
								<td class="view_text_left">${board_detail2_map.gisu_crc_nm}</td>
								<th scope="row">중요공지(체크)</th>
								<td class="view_text_left">
									<input type="checkbox" disabled="disabled" ${board_detail2_map.board_content_imp == "A1100" ? "CHECKED" : "" } />
								</td>
							</tr>
					...
					<!-- 목록으로 버튼 -->
					<form action="/smp/admin/board"	id="boardHiddenManagerForm" method="get">
