...
$(function() {
	...
	$('#refund_submit').on('click', function(){
		...
		if(confirm('환불정보를 수정하시겠습니까?')){
			...
			$.ajax({
				type : "POST",
				url: "/smtp/user/paybackUpdate-submit",
...
<body>
    <div class="container_rainbow">
        <div class="content sub-content view-refund" id="main">
            <div class="header">
                <div class="titleBar h3">환불현황</div>
            </div>
            <div class="section">
                ...
                <div class="sub-segment">
                    <form action="/smtp/user/paybackUpdate-submit" method="post" id="refund_form" class="formStyle">
				...
				<input type="hidden" name="pay_refund_seq" value="${accInfo.PAY_REFUND_SEQ}">     
                        <div class="d-flex">
                            ...
                            <input type="text" class="input" id="bank" name="bank" placeholder="은행명을 입력하세요." value="${accInfo.PAY_REFUND_BANK}">
                        </div>
                        <div class="d-flex">
                            <label class="label" for="account">계좌번호</label>
                            <input type="text" class="input" id="account" name="account" placeholder="계좌번호를을 입력하세요." value="${accInfo.PAY_REFUND_ACCNUM}">
                        </div>
                        <div class="d-flex">
                            <label class="label" for="owner">예금주</label>
                            <input type="text" class="input" id="owner" name="owner" placeholder="예금주를 입력하세요." value="${accInfo.PAY_REFUND_ACCNAME}">
                        </div>
<!--                         <div class="margin-top40">
							<input type="button" id="refund_submit" class="btn_normal btn_pp_bg btn_large" value="환불수정">
							<input type="button" id="refund_cancel" class="btn_normal btn_default btn_large" value="환불취소">
                        </div> -->
                        <div class="button-wrap d-flex justify_end margin-top40">
							<button class="btn_normal btn_pp btn_large close-modal" id="refund_cancel" type="button">환불취소</button>
							<button class="btn_normal btn_pp_bg btn_large margin-left20 btnSubmit" id="refund_submit" type="button">환불수정</button>
						</div>
                    </form>
                </div>
            </div>
