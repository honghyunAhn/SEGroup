...
// 		$('.ctf_birth').html(birthArr[2] + '년 ' + birthArr[0] + ' ' + birthArr[1].replace(',', '') + '일');
		$('.ctf_birth').html(userInfo.user_birth);
...
<body>
	<div class="container_rainbow print-body">
        <div class="content sub-content sub05_content view-certificate view-certificate_training" id="main">
