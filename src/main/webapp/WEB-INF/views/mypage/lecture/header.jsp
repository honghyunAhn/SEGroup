        ...
        <div class="mobile-headerWrap">
            ...
            <div class="mobile-hdr-loginWrap">
                <ul class="user-menu d-flex">
                    <li class="menu-list logon d-n h5"><a href="/lms/user/sub00-01">로그인</a></li>
                    <li class="menu-list myclass d-b h5"><a href="/lms/user/sub07-01-01">나의 강의실</a></li>
                    <li class="menu-list logout d-b h5">로그아웃</li>
                    <li class="menu-list join d-n h5"><a href="/lms/user/sub00-02">회원가입</a></li>
                </ul>
            </div>
            <div class="m-navBg">
                <div class="m-navGroup">
                    ...
                    <div class="mobile-navGroup">
                        <ul class="menu-title-division">
                            <li class="gnb fz14 mobileItCate "><a href="/lms/course/it/sub01-01">ICT
                                    <!--<div class="img-icon angle-right angle-down"></div>--></a></li>
                        </ul>
                        <ul class="menu-title-division">
                            <li class="gnb fz14 mobileForeignCate">
                                <a href="/lms/course/foreign/sub02-01">
                                    외국어
                        ...
                        <ul class="menu-title-division">
                            <li class="gnb fz14 mobileBusinessCate"><a href="/lms/course/business/sub03-01">직무역량</a></li>
<!--                             <li class="lnb fz14"><a href="/lms/course/business/sub03-01">경영/금융</a></li>
                        ...
                        <ul class="menu-title-division">
                            <li class="gnb fz14"><a href="/lms/community/sub05-01-01">커뮤니티</a></li>
                            <li class="lnb fz14"><a href="/lms/community/sub05-01-01">공지사항</a></li>
                            <li class="lnb fz14"><a href="/lms/community/sub05-01-02">이벤트</a></li>
                       </ul>
                             </li>
                             <%-- 
                            <li class="lnb fz14">
...
<!--                             <li class="lnb fz14"><a href="/lms/community/sub05-04">자유게시판</a></li> -->
                        ...
                        <ul class="menu-title-division">
                            <li class="gnb fz14"><a href="/lms/support/sub06-01-01">고객센터
                                    <!--<div class="img-icon angle-right angle-down"></div>--></a></li>
                            <li class="lnb fz14">
                                <!-- <a href="sub06-01-01.html"> -->
                                    ...
                                    <div class="img-icon angle-right angle-down"></div>
                                    <ul class="menu-sub">
                                        <li><a href="/lms/support/sub06-01-01">- 학습자 PC 환경설정</a></li>
                                        <!-- <li><a href="/lms/support/sub06-01-02">- PC 원격지원</a></li> -->
                                    </ul>
                                <!-- </a> -->
                            </li>
                            <li class="lnb fz14">
                                <a href="/lms/support/sub06-02">
                                    FAQ
                                    <!-- <div class="img-icon angle-right angle-down"></div> -->
                                </a>
                            </li>
                            <li class="lnb fz14">
                                <a href="/lms/support/sub06-03">
                                    단체/제휴문의
                                    <!-- <div class="img-icon angle-right angle-down"></div> -->
                                </a>
                            </li>
                            <li class="lnb fz14">
                                <a href="/lms/support/sub06-04">
                                    오시는길
                                    <!-- <div class="img-icon angle-right angle-down"></div> -->
                                </a>
                                <!-- <ul class="menu-sub">
                        ...
                        <ul class="menu-title-division bl">
                            <li class="gnb fz14"><a href="/lms/user/sub07-01">나의강의실</a></li>
                            <li class="lnb fz14"><a href="/lms/user/sub07-01-01">학습현황</a></li>
                            <li class="lnb fz14"><a href="/lms/user/sub07-02">결제현황/환불</a></li>
                            <li class="lnb fz14"><a href="/lms/user/sub07-03">마일리지</a></li>
                            <li class="lnb fz14"><a href="/lms/user/sub07-04">개인정보수정</a></li>
                            <li class="lnb fz14"><a href="/lms/user/sub07-05">회원탈퇴</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="listWrap block">
                            <div class="topMenu-notice">
                            	<c:forEach var="item" items="${headerNoticeList}" varStatus="status">
                            		<div class="notice">
                            			<a class="text-over" href="<c:url value="/lms/community/sub05-01-view"/>?id=${item.ID}&notice_type=${item.NOTICE_TYPE }&board_type=1">
                    ...
                    <ul class="user-menu d-flex">
                        ...
                        <c:choose>
							<c:when test="${empty check }">
		                        <li class="menu-list d-n h5"><a href="/lms/user/sub00-01">로그인</a></li>
		                        <li class="menu-list d-n h5"><a href="/lms/user/sub00-02">회원가입</a></li>
	                        </c:when>
	                        <c:otherwise>
	                        	<li class="menu-list welcome d-b h5">
                            	<span class="user-name">${sessionScope.user_id}</span>님 환영합니다.
                       			 </li>
		                        <li class="menu-list d-b h5"><a href="/lms/user/sub07-01-01">나의 강의실</a></li>
        ...
        <div class="hdrWrap midMenu-wrapper">
            ...
            <header class="header">
                <div class="header-wrap">
                    ...
                    <!-- 검색어입력 -->
                     <form class="header-search d-flex" action="/lms/course/search/sub05-01" method="GET"> 
                ...
                <div class="nav-menu">
                    ...
                    <ul class="navGroup d-flex">
                        ...
                        <li class="gnb sub01 fz16">
                            <a href="/lms/course/it/sub01-01">ICT</a>
                            <ul class="lnb fz14 navIt">
                            </ul>
                        </li>
                        <!-- ↓ 외국어 -->
                        <li class="gnb sub02 fz16">
                            <a href="/lms/course/foreign/sub02-01">외국어</a>
                            <ul class="lnb fz14 navForeign">
                            </ul>
                        </li>
                        <!-- ↓ 직무역량 -->
                        <li class="gnb sub03 fz16">
                            <a href="/lms/course/business/sub03-01">직무역량</a>
                            <ul class="lnb fz14 navBusiness">
                            </ul>
                        </li>            
                        <!-- ↓ 커뮤니티 -->
                        <li class="gnb sub05 fz16">
                            <a href="/lms/community/sub05-01-01">커뮤니티</a>
                            <ul class="lnb fz14">                                 
                                <li><a href="/lms/community/sub05-01-01">공지사항</a></li>
                                <li><a href="/lms/community/sub05-01-02">이벤트</a></li>
...
<!--                                 <li><a href="/lms/community/sub05-04">자유게시판</a></li> -->
                        ...
                        <li class="gnb sub06 fz16">
                            <a href="/lms/support/sub06-01-01">고객센터</a>
                            <ul class="lnb fz14">
                         ...
                         <li class="gnb sub06 fz16">
                            <a href="/lms/user/sub07-01-01">나의강의실</a> 
                            <ul class="lnb fz14">
                                <li><a href="/lms/user/sub07-01-01">학습현황</a></li>
                                <li><a href="/lms/user/sub07-02">결제현황/환불</a></li>
                                <li><a href="/lms/user/sub07-03">마일리지</a></li>
                                <li><a href="/lms/user/sub07-04">개인정보수정</a></li>
                                 <li><a href="/lms/user/sub07-05">회원탈퇴</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
        ...
        <div class="fullWrapper">
            <div class="full-background">
                ...
                <div class="full-navGroup">
                    <ul class="menu-title-division">
                        <li class="gnb fz14 webItCate"><a href="/lms/course/it/sub01-01">ICT</a></li>
<!--                         <li class="lnb fz14">
                    ...
                    <!-- <hr> -->
                    <ul class="menu-title-division">
                        <li class="gnb fz14 webForeignCate"><a href="/lms/course/foreign/sub02-01">외국어</a></li>
<!--                         <li class="lnb fz14">
                    ...
                    <!-- <hr> -->
                    <ul class="menu-title-division">
                        <li class="gnb fz14 webBusinessCate"><a href="/lms/course/business/sub03-01">직무역량</a></li>
<!--                         <li class="lnb fz14">
...
<!--                         <li class="lnb fz14"><a href="/lms/community/sub05-04">자유게시판</a></li> -->
                    ...
                    <!-- <hr> -->
                    <ul class="menu-title-division">
                        <li class="gnb fz14"><a href="/lms/support/sub06-01-01">고객센터</a></li>
                        <li class="lnb fz14">
                            <a href="/lms/support/sub06-01-01">고객지원</a>
                            <ul class="menu-sub h5">
                                <li><a href="/lms/support/sub06-01-01">학습자 PC 환경설정</a></li>
                    ...
                    <!--  -->
                    <ul class="menu-title-division">
                        <li class="gnb fz14"><a href="/lms/support/sub07-01-01">나의강의실</a></li>
                        <li class="lnb fz14">
                            <a href="/lms/support/sub07-01-01">학습현황</a>              
                        </li>
                        <li class="lnb fz14">
                            <a href="/lms/support/sub07-02">결제현황/환불</a>              
                        </li>
                        <li class="lnb fz14">
                            <a href="/lms/support/sub07-03">마일리지</a>              
                        </li>
                        <li class="lnb fz14">
                            <a href="/lms/support/sub07-04">개인정보수정</a>              
                        </li>
                        <li class="lnb fz14">
                            <a href="/lms/support/sub07-05">회원탈퇴</a>              
                        </li>
                    </ul>
                    <!--  -->
