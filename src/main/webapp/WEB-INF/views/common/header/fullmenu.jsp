						...
						<c:if test="${currentDevice.mobile }">
							...
							<sec:authorize access="isAuthenticated()">
								<p class="loginMenu">
									...
									<a href="<c:url value="/mypage/private/privateedit"/>" class="btn">개인 정보 수정</a>
								</p>
							</sec:authorize>
							</c:if>
							...
							<li>
								...
								<ul class="menu-d2">
									...
									<li>
										<a href="#">개인 정보</a>
										<ul class="menu-d3">
											<li><a href="javascript:authAlertMove('<c:url value="/mypage/private/privateedit"/>')">개인 정보 수정</a></li>
