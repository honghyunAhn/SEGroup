...
$(document).ready(function(){
	...
	$("#btnGenNeis").click(function(event) {	// 임시 NEIS번호 발급
		/*
					...
					<form id="applyForm" name="applyForm" method="post" action="<c:url value="/learn/apply/doApply"/>">
						...
						<div class="group">
							...
							<dl>
								...
								<dd class="NEIS">
									...
									<a class="btn primary" href="<c:url value="/mypage/private/privatecertification"/>" id="btnGenNeis">번호 수정</a>
									<p>
						...
						<div class="group">
							...
							<p class="section-body-footer alignR">
								<a class="btn line primary" href="<c:url value="/mypage/private/privatecertification"/>">개인 정보 수정</a>
							</p>
						</div><!--//.group - 개인 정보 확인 -->
						<div class="group">
							<h3>쿠폰 및 포인트 사용</h3>
							<ul class="section">
								<li>쿠폰 사용시 1회 사용 가능하며, 사용한 쿠폰은 복원되지 않습니다.</li>
								<li>교재는 쿠폰 적용되지 않습니다.</li>
