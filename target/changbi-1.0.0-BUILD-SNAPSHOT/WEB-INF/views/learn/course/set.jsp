...
function searchList(course_code) {
	...
	location.href = '<c:url value="/learn/course/set"/>?course_code='+course_code+'&sort='+sort;
}
</script>
...
<!-- 1.3. 본문 -->
		<div class="body">
			<div class="sub-header">
				<p class="sub-nav">
					<a class="nth-1st" href="${contextPath}"><span class="sr-only">HOME</span></a>
					<a href="#">연수 신청</a>
					<a class="nth-last" href=''>집합 연수</a>
				</p>
				<h2 class="sub-title">집합 연수 </h2>
