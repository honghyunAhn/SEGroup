		...
		<ul class="menu-d2">
			...
			<li>
				...
				<ul class="menu-d3" style="display: block;">
					<li><a class='<c:if test="${fn:contains(contextPathsub[fn:length(contextPathsub)-1],'privatecertification')}">on</c:if>' href="/mypage/private/privatecertification">개인 정보 수정</a></li>
