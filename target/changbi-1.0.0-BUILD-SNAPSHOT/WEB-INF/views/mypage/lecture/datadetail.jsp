			...
			<div class="sub-body">
				<div class="tab-group">
					<ul class="tab-header sub x7">
							...
							<li><a class="nth-1st on" href="dataroom?id=${classParam.id }&cardinal=${classParam.cardinal }&course=${classParam.course }">자료실</a></li>
							...
							<div class="group">
								...
								<div class="board-view">
									<div class="view-header">
										...
										<div class="view-info">
											<span class="writer">작성자<strong>${detail.user_id}</strong></span><span class="date">작성일<strong>${detail.reg_date_format2}</strong></span>
