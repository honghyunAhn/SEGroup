...
function onIdentitySuccess(iden_gbn, data) {
	...
	var id = '${param.id}';
	var cardinal = '${param.cardinal}';
	var course = '${param.course}';
	location.href = '<c:url value="/mypage/lecture/classroom"/>?id='+id+'&cardinal='+cardinal+'&course='+course;
}
...
<div class="body">
	...
	<div class="sub-body">
		<div class="certification">
			<h3>본인 인증</h3>
			<p>강의실은 본인 확인 후 입장하실 수 있습니다.<br>본인 인증 수단을 선택하여 주시기 바랍니다.</p>
			<ul>
				<li>
					<div class="phone">
						<span>휴대 전화 인증</span>
