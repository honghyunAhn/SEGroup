...
<div class="body">
	...
	<div class="sub-body">
		...
		<input type="hidden" id="grade" name="grade" value="${identForm.grade }"/>
		<input type="hidden" name="iden_di" value="${identForm.iden_di }"/>
			<div class="group">
				...
				<dl>
					<dt>아이디<i>*</i></dt>
					<dd>
						<input class="nth-1st" type="text" id="id1" name="id1" maxlength="20" value="${memberForm.id1 }">@<input type="text" id="id2" name="id2" class="target_id2" maxlength="20" value="${memberForm.id2 }">
						<div class="body-select width15">
							<a class="btn-toggle" href="#select-id"><span class="target_id2">직접 입력</span></a>
							<ul class="select-option off" id="select-id" data-target="target_id2">
						...
						<span class="explan">※ 전자 우편을 아이디로 사용합니다.</span>
						<input type="hidden" id="id" name="id" value="${memberForm.id }"/>
					</dd>
					<dt>성명<i>*</i></dt>
		...
		<div class="list-bottom alignC">
			<a href="#" class="btn primary" id="btnNext">다음</a>
			<a href="#" class="btn danger" id="btnCancel">취소</a>
		</div>
		</c:if>
